...
enum opt_code
{
  ...
  OPT_mandroid = 1192,                       /* -mandroid */
  OPT_mapcs = 1193,                          /* -mapcs */
  OPT_mapcs_frame = 1194,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1195,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1196,              /* -mapcs-stack-check */
  OPT_march_ = 1197,                         /* -march= */
  OPT_marm = 1198,                           /* -marm */
  OPT_masm_syntax_unified = 1199,            /* -masm-syntax-unified */
  OPT_mbe32 = 1200,                          /* -mbe32 */
  OPT_mbe8 = 1201,                           /* -mbe8 */
  OPT_mbig_endian = 1202,                    /* -mbig-endian */
  OPT_mbionic = 1203,                        /* -mbionic */
  OPT_mbranch_cost_ = 1204,                  /* -mbranch-cost= */
  ...
  OPT_mflip_thumb = 1210,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1211,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1212,                  /* -mfp16-format= */
  OPT_mfpu_ = 1213,                          /* -mfpu= */
  OPT_mglibc = 1214,                         /* -mglibc */
  /* OPT_mhard_float = 1215, */              /* -mhard-float */
  OPT_minline_thumb1_jumptable = 1216,       /* -minline-thumb1-jumptable */
  OPT_mlittle_endian = 1217,                 /* -mlittle-endian */
  OPT_mlong_calls = 1218,                    /* -mlong-calls */
  OPT_mmusl = 1219,                          /* -mmusl */
  OPT_mneon_for_64bits = 1220,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1221,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1222,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1223,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1224,               /* -mprint-tune-info */
  OPT_mpure_code = 1225,                     /* -mpure-code */
  OPT_mrestrict_it = 1226,                   /* -mrestrict-it */
  OPT_msched_prolog = 1227,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1228,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1229,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1230, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1231,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1232,                         /* -mthumb */
  OPT_mthumb_interwork = 1233,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1234,                  /* -mtls-dialect= */
  OPT_mtp_ = 1235,                           /* -mtp= */
  OPT_mtpcs_frame = 1236,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1237,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1238,                         /* -mtune= */
  OPT_muclibc = 1239,                        /* -muclibc */
  OPT_munaligned_access = 1240,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1241,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1242,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1243,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1244,              /* -mword-relocations */
  OPT_n = 1245,                              /* -n */
  OPT_no_canonical_prefixes = 1246,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1247,              /* -no-integrated-cpp */
  OPT_no_pie = 1248,                         /* -no-pie */
  OPT_nocpp = 1249,                          /* -nocpp */
  OPT_nodefaultlibs = 1250,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1251,                   /* -nostartfiles */
  OPT_nostdinc = 1252,                       /* -nostdinc */
  OPT_nostdinc__ = 1253,                     /* -nostdinc++ */
  OPT_nostdlib = 1254,                       /* -nostdlib */
  OPT_o = 1255,                              /* -o */
  OPT_p = 1256,                              /* -p */
  OPT_pass_exit_codes = 1257,                /* -pass-exit-codes */
  /* OPT_pedantic = 1258, */                 /* -pedantic */
  OPT_pedantic_errors = 1259,                /* -pedantic-errors */
  OPT_pg = 1260,                             /* -pg */
  OPT_pie = 1261,                            /* -pie */
  OPT_pipe = 1262,                           /* -pipe */
  OPT_posix = 1263,                          /* -posix */
  OPT_print_file_name_ = 1264,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1265,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1266,          /* -print-multi-directory */
  OPT_print_multi_lib = 1267,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1268,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1269,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1270,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1271,               /* -print-prog-name= */
  OPT_print_search_dirs = 1272,              /* -print-search-dirs */
  OPT_print_sysroot = 1273,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1274,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1275,                        /* -profile */
  OPT_pthread = 1276,                        /* -pthread */
  OPT_quiet = 1277,                          /* -quiet */
  OPT_r = 1278,                              /* -r */
  OPT_rdynamic = 1279,                       /* -rdynamic */
  OPT_remap = 1280,                          /* -remap */
  OPT_s = 1281,                              /* -s */
  OPT_save_temps = 1282,                     /* -save-temps */
  OPT_save_temps_ = 1283,                    /* -save-temps= */
  OPT_shared = 1284,                         /* -shared */
  OPT_shared_libgcc = 1285,                  /* -shared-libgcc */
  /* OPT_specs = 1286, */                    /* -specs */
  OPT_specs_ = 1287,                         /* -specs= */
  OPT_static = 1288,                         /* -static */
  OPT_static_libasan = 1289,                 /* -static-libasan */
  OPT_static_libgcc = 1290,                  /* -static-libgcc */
  OPT_static_libgfortran = 1291,             /* -static-libgfortran */
  OPT_static_libgo = 1292,                   /* -static-libgo */
  OPT_static_liblsan = 1293,                 /* -static-liblsan */
  OPT_static_libmpx = 1294,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1295,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1296,               /* -static-libstdc++ */
  OPT_static_libtsan = 1297,                 /* -static-libtsan */
  OPT_static_libubsan = 1298,                /* -static-libubsan */
  OPT_static_pie = 1299,                     /* -static-pie */
  /* OPT_std_c__03 = 1300, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1301, */                /* -std=c++0x */
  OPT_std_c__11 = 1302,                      /* -std=c++11 */
  OPT_std_c__14 = 1303,                      /* -std=c++14 */
  OPT_std_c__17 = 1304,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1305, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1306, */                /* -std=c++1z */
  OPT_std_c__2a = 1307,                      /* -std=c++2a */
  OPT_std_c__98 = 1308,                      /* -std=c++98 */
  OPT_std_c11 = 1309,                        /* -std=c11 */
  OPT_std_c17 = 1310,                        /* -std=c17 */
  /* OPT_std_c18 = 1311, */                  /* -std=c18 */
  ...
  OPT_std_f2018 = 1320,                      /* -std=f2018 */
  OPT_std_f95 = 1321,                        /* -std=f95 */
  OPT_std_gnu = 1322,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1323, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1324, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1325,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1326,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1327,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1328, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1329, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1330,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1331,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1332,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1333,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1334, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1345, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1346, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1347,                     /* -std=legacy */
  OPT_symbolic = 1348,                       /* -symbolic */
  OPT_t = 1349,                              /* -t */
  OPT_time = 1350,                           /* -time */
  OPT_time_ = 1351,                          /* -time= */
  OPT_tno_android_cc = 1352,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1353,                 /* -tno-android-ld */
  OPT_traditional = 1354,                    /* -traditional */
  OPT_traditional_cpp = 1355,                /* -traditional-cpp */
  OPT_trigraphs = 1356,                      /* -trigraphs */
  OPT_u = 1357,                              /* -u */
  OPT_undef = 1358,                          /* -undef */
  OPT_v = 1359,                              /* -v */
  OPT_version = 1360,                        /* -version */
  OPT_w = 1361,                              /* -w */
  OPT_wrapper = 1362,                        /* -wrapper */
  OPT_x = 1363,                              /* -x */
  OPT_z = 1364,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
