...
#define MBEDTLS_ERR_X509_FATAL_ERROR                                                               \
	-0x3000 /**< A fatal error occured, eg the chain is too long or the vrfy callback failed. */
/* \} name */
...
#define MBEDTLS_X509_BADCERT_BAD_KEY                                                               \
	0x010000 /**< The certificate is signed with an unacceptable key (eg bad curve, RSA too        \
	            short). */
