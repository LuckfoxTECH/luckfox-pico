...
#define MBEDTLS_ERR_SSL_NO_CIPHER_CHOSEN                                                           \
	-0x7380 /**< The server has no ciphersuites in common with the client. */
#define MBEDTLS_ERR_SSL_NO_RNG -0x7400 /**< No RNG was provided to the SSL module. */
#define MBEDTLS_ERR_SSL_NO_CLIENT_CERTIFICATE                                                      \
	-0x7480 /**< No client certification received from the client, but required by the             \
	           authentication mode. */
...
#define MBEDTLS_ERR_SSL_CERTIFICATE_REQUIRED                                                       \
	-0x7580 /**< The own certificate is not set, but needed by the server. */
...
#define MBEDTLS_ERR_SSL_BAD_HS_CLIENT_HELLO                                                        \
	-0x7900 /**< Processing of the ClientHello handshake message failed. */
#define MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO                                                        \
	-0x7980 /**< Processing of the ServerHello handshake message failed. */
...
#define MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_REQUEST                                                 \
	-0x7A80 /**< Processing of the CertificateRequest handshake message failed. */
#define MBEDTLS_ERR_SSL_BAD_HS_SERVER_KEY_EXCHANGE                                                 \
	-0x7B00 /**< Processing of the ServerKeyExchange handshake message failed. */
#define MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO_DONE                                                   \
	-0x7B80 /**< Processing of the ServerHelloDone handshake message failed. */
#define MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE                                                 \
	-0x7C00 /**< Processing of the ClientKeyExchange handshake message failed. */
#define MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_RP                                              \
	-0x7C80 /**< Processing of the ClientKeyExchange handshake message failed in DHM / ECDH Read   \
	           Public. */
#define MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_CS                                              \
	-0x7D00 /**< Processing of the ClientKeyExchange handshake message failed in DHM / ECDH        \
	           Calculate Secret. */
#define MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_VERIFY                                                  \
	-0x7D80 /**< Processing of the CertificateVerify handshake message failed. */
#define MBEDTLS_ERR_SSL_BAD_HS_CHANGE_CIPHER_SPEC                                                  \
	-0x7E00 /**< Processing of the ChangeCipherSpec handshake message failed. */
#define MBEDTLS_ERR_SSL_BAD_HS_FINISHED                                                            \
	-0x7E80 /**< Processing of the Finished handshake message failed. */
...
#define MBEDTLS_ERR_SSL_COMPRESSION_FAILED                                                         \
	-0x6F00 /**< Processing of the compression / decompression failed */
#define MBEDTLS_ERR_SSL_BAD_HS_PROTOCOL_VERSION                                                    \
	-0x6E80 /**< Handshake protocol not within min/max boundaries */
#define MBEDTLS_ERR_SSL_BAD_HS_NEW_SESSION_TICKET                                                  \
	-0x6E00 /**< Processing of the NewSessionTicket handshake message failed. */
...
#define MBEDTLS_ERR_SSL_NO_USABLE_CIPHERSUITE                                                      \
	-0x6980 /**< None of the common ciphersuites is usable (eg, no suitable certificate, see debug \
	           messages). */
...
#define MBEDTLS_ERR_SSL_INVALID_VERIFY_HASH                                                        \
	-0x6600 /**< Couldn't set the hash for verifying CertificateVerify */
 ...
 */
typedef int mbedtls_ssl_async_sign_t(mbedtls_ssl_context *ssl, mbedtls_x509_crt *cert,
 ...
 *                  directed in the documentation of this callback.
 */
typedef int mbedtls_ssl_async_decrypt_t(mbedtls_ssl_context *ssl, mbedtls_x509_crt *cert,
 ...
 *                  directed in the documentation of this callback.
 */
typedef int mbedtls_ssl_async_resume_t(mbedtls_ssl_context *ssl, unsigned char *output,
...
typedef struct mbedtls_dtls_srtp_info_t {
	...
	unsigned char
	    dtls_srtp_keys[MBEDTLS_DTLS_SRTP_MAX_KEY_MATERIAL_LENGTH]; /*!< master keys and master salt
	                                                                  for SRTP generated during
	                                                                  handshake */
	size_t dtls_srtp_keys_len; /*!< length in bytes of master keys and master salt for SRTP
...
struct mbedtls_ssl_config {
	...
	int (*f_ticket_write)(void *, const mbedtls_ssl_session *, unsigned char *,
	...
	int (*f_export_keys)(void *, const unsigned char *, const unsigned char *, size_t, size_t,
	                     size_t);
	...
	mbedtls_ssl_async_decrypt_t
	    *f_async_decrypt_start;                 /*!< start asynchronous decryption operation */
#endif                                          /* MBEDTLS_X509_CRT_PARSE_C */
	mbedtls_ssl_async_resume_t *f_async_resume; /*!< resume asynchronous operation */
	mbedtls_ssl_async_cancel_t *f_async_cancel; /*!< cancel asynchronous operation */
	void
	    *p_async_config_data; /*!< Configuration data set by mbedtls_ssl_conf_async_private_cb(). */
#endif                        /* MBEDTLS_SSL_ASYNC_PRIVATE */
...
extern int (*mbedtls_ssl_hw_record_init)(mbedtls_ssl_context *ssl, const unsigned char *key_enc,
                                         const unsigned char *key_dec, size_t keylen,
                                         const unsigned char *iv_enc, const unsigned char *iv_dec,
                                         size_t ivlen, const unsigned char *mac_enc,
                                         const unsigned char *mac_dec, size_t maclen);
 ...
 */
typedef int mbedtls_ssl_ticket_write_t(void *p_ticket, const mbedtls_ssl_session *session,
 ...
 *                  a specific MBEDTLS_ERR_XXX code.
 */
typedef int mbedtls_ssl_export_keys_t(void *p_expkey, const unsigned char *ms,
 ...
 */
typedef int mbedtls_ssl_ticket_parse_t(void *p_ticket, mbedtls_ssl_session *session,
 ...
 */
typedef int mbedtls_ssl_cookie_write_t(void *ctx, unsigned char **p, unsigned char *end,
 ...
 *                 or a negative error code.
 */
typedef int mbedtls_ssl_cookie_check_t(void *ctx, const unsigned char *cookie, size_t clen,
                                       const unsigned char *info, size_t ilen);
 ...
 */
void mbedtls_ssl_conf_ciphersuites_for_version(mbedtls_ssl_config *conf, const int *ciphersuites,
                                               int major, int minor);
 ...
 * \return         0 if successful
 */
MBEDTLS_DEPRECATED int mbedtls_ssl_conf_dh_param(mbedtls_ssl_config *conf, const char *dhm_P,
                                                 const char *dhm_G);
 ...
 */
int mbedtls_ssl_get_dtls_srtp_key_material(const mbedtls_ssl_context *ssl, unsigned char *key,
                                           size_t *key_len);
 ...
 */
const mbedtls_ssl_srtp_profile_info *
mbedtls_ssl_dtls_srtp_profile_info_from_id(mbedtls_ssl_srtp_profile profile);
#endif /* MBEDTLS_SSL_DTLS_SRTP */
 ...
 *                 mbedtls_ssl_read(), as opposed to mbedtls_ssl_write() and
 * mbedtls_ssl_renegotiate() which always behave as if max_record was 0. The reason is, if we
 * receive application data from the server, we need a place to write it, which only happens during
 * mbedtls_ssl_read().
 *
 * \param conf     SSL configuration
