...
#define MBEDTLS_ERR_RIPEMD160_HW_ACCEL_FAILED                                                      \
	-0x0031 /**< RIPEMD160 hardware accelerator failed                                             \
	         */
 ...
 * \return         0 if successful
 */
int mbedtls_ripemd160_update_ret(mbedtls_ripemd160_context *ctx, const unsigned char *input,
                                 size_t ilen);
 ...
 * \param output   RIPEMD-160 checksum result
 */
MBEDTLS_DEPRECATED void mbedtls_ripemd160(const unsigned char *input, size_t ilen,
                                          unsigned char output[20]);
