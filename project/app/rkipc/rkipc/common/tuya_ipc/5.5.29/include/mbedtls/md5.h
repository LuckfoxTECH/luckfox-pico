 ...
 *
 */
MBEDTLS_DEPRECATED void mbedtls_md5_update(mbedtls_md5_context *ctx, const unsigned char *input,
                                           size_t ilen);
 ...
 *
 */
MBEDTLS_DEPRECATED void mbedtls_md5(const unsigned char *input, size_t ilen,
