 ...
 *
 */
MBEDTLS_DEPRECATED void mbedtls_md2_update(mbedtls_md2_context *ctx, const unsigned char *input,
                                           size_t ilen);
 ...
 *
 */
MBEDTLS_DEPRECATED void mbedtls_md2(const unsigned char *input, size_t ilen,
