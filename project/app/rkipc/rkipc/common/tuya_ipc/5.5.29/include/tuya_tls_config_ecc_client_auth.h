...
#ifndef MBEDTLS_CONFIG_H_TY_ECC_CLEINT_AUTH
 ...
 *
 */
#if 1 //((ENABLE_ECHO_SHOW ==1) || (ENABLE_CHROMECAST==1) || (TUYA_OPERATOR_TYPE ==
      // TUYA_OPERATOR_CMCC_ANDLINK) )
...
///**< Maximum size of (re)seed buffer */ #define MBEDTLS_CTR_DRBG_USE_128_BIT_KEY              /**<
...
#define MBEDTLS_SSL_MAX_CONTENT_LEN                                                                \
	5200 /**< Maxium fragment length in bytes, determines the size of each of the two internal I/O \
	        buffers */
#else
...
//#define MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME     86400 /**< Lifetime of session tickets (if
// enabled) */ #define MBEDTLS_PSK_MAX_LEN               32 /**< Max size of TLS pre-shared keys, in
// bytes (default 256 bits) */ #define MBEDTLS_SSL_COOKIE_TIMEOUT        60 /**< Default expiration
...
#endif /* MBEDTLS_CONFIG_H_TY_ECC_PSK */
