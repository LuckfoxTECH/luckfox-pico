...
#ifndef MBEDTLS_CONFIG_H_TY_ECC_ONLY
 ...
 *
 */
//#if ((ENABLE_ECHO_SHOW ==1) || (ENABLE_CHROMECAST==1) || (TUYA_OPERATOR_TYPE ==
...
#define MBEDTLS_SSL_MAX_CONTENT_LEN                                                                \
	16384 /**< Maxium fragment length in bytes, determines the size of each of the two internal    \
	         I/O buffers */
#else
