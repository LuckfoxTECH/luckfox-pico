...
#define MBEDTLS_ERR_CTR_DRBG_REQUEST_TOO_BIG                                                       \
	-0x0036 /**< The requested random buffer length is too big. */
#define MBEDTLS_ERR_CTR_DRBG_INPUT_TOO_BIG                                                         \
	-0x0038 /**< The input (entropy + additional data) is too large. */
...
#define MBEDTLS_CTR_DRBG_KEYSIZE                                                                   \
	16 /**< The key size used by the cipher (compile-time choice: 128 bits). */
#else
#define MBEDTLS_CTR_DRBG_KEYSIZE                                                                   \
	32 /**< The key size used by the cipher (compile-time choice: 256 bits). */
#endif

#define MBEDTLS_CTR_DRBG_KEYBITS                                                                   \
	(MBEDTLS_CTR_DRBG_KEYSIZE * 8) /**< The key size for the DRBG operation, in bits. */
#define MBEDTLS_CTR_DRBG_SEEDLEN                                                                   \
	(MBEDTLS_CTR_DRBG_KEYSIZE +                                                                    \
	 MBEDTLS_CTR_DRBG_BLOCKSIZE) /**< The seed length, calculated as (counter + AES key). */
 ...
 */
int mbedtls_ctr_drbg_update_ret(mbedtls_ctr_drbg_context *ctx, const unsigned char *additional,
                                size_t add_len);
