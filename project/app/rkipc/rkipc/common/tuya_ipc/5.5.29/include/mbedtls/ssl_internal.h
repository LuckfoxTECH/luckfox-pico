...
/* Shorthand for restartable ECC */
    ...
    defined(MBEDTLS_SSL_PROTO_TLS1_2) && defined(MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED)
...
#define MBEDTLS_SSL_PAYLOAD_OVERHEAD                                                               \
	(MBEDTLS_SSL_COMPRESSION_ADD + MBEDTLS_MAX_IV_LENGTH + MBEDTLS_SSL_MAC_ADD +                   \
	 MBEDTLS_SSL_PADDING_ADD)

#define MBEDTLS_SSL_IN_PAYLOAD_LEN (MBEDTLS_SSL_PAYLOAD_OVERHEAD + (MBEDTLS_SSL_IN_CONTENT_LEN))

#define MBEDTLS_SSL_OUT_PAYLOAD_LEN (MBEDTLS_SSL_PAYLOAD_OVERHEAD + (MBEDTLS_SSL_OUT_CONTENT_LEN))
...
#define MBEDTLS_TLS_EXT_ADV_CONTENT_LEN                                                            \
	((MBEDTLS_SSL_IN_CONTENT_LEN > MBEDTLS_SSL_OUT_CONTENT_LEN) ? (MBEDTLS_SSL_OUT_CONTENT_LEN)    \
...
#define MBEDTLS_SSL_COMPRESS_BUFFER_LEN                                                            \
	((MBEDTLS_SSL_IN_BUFFER_LEN > MBEDTLS_SSL_OUT_BUFFER_LEN) ? MBEDTLS_SSL_IN_BUFFER_LEN          \
...
struct mbedtls_ssl_handshake_params {
	...
	int (*tls_prf)(const unsigned char *, size_t, const char *, const unsigned char *, size_t,
...
void mbedtls_ssl_sig_hash_set_add(mbedtls_ssl_sig_hash_set_t *set, mbedtls_pk_type_t sig_alg,
...
int mbedtls_ssl_check_cert_usage(const mbedtls_x509_crt *cert,
                                 const mbedtls_ssl_ciphersuite_t *ciphersuite, int cert_endpoint,
                                 uint32_t *flags);
#endif /* MBEDTLS_X509_CRT_PARSE_C */
...
#if defined(MBEDTLS_SSL_PROTO_SSL3) || defined(MBEDTLS_SSL_PROTO_TLS1) ||                          \
    defined(MBEDTLS_SSL_PROTO_TLS1_1)
int mbedtls_ssl_get_key_exchange_md_ssl_tls(mbedtls_ssl_context *ssl, unsigned char *output,
...
int mbedtls_ssl_get_key_exchange_md_tls1_2(mbedtls_ssl_context *ssl, unsigned char *hash,
                                           size_t *hashlen, unsigned char *data, size_t data_len,
                                           mbedtls_md_type_t md_alg);
