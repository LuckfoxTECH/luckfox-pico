...
void setUp(void) { /* Function run before every test */
}
...
void test_dropdown_set_options(void) {
  ...
  lv_dropdown_set_options(dd1, "o1\no2"); /*Just to add some content before
...
void test_dropdown_render_1(void) {
  ...
  lv_obj_set_style_bg_color(list, lv_color_hex3(0xf00),
...
void test_dropdown_render_2(void) {
  ...
  lv_obj_set_style_text_align(lv_dropdown_get_list(dd6), LV_TEXT_ALIGN_RIGHT,
                              0);
