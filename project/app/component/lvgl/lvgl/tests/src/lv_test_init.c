...
static void dummy_flush_cb(lv_disp_drv_t *disp_drv, const lv_area_t *area,
                           lv_color_t *color_p);
...
void lv_test_deinit(void) { lv_mem_deinit(); }
...
static lv_fs_res_t read_cb(lv_fs_drv_t *drv, void *file_p, void *buf,
...
static lv_fs_res_t seek_cb(lv_fs_drv_t *drv, void *file_p, uint32_t pos,
                           lv_fs_whence_t w) {
  (void)drv;
