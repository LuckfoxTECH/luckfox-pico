...
void lv_test_mouse_press(void) { mouse_pressed = true; }

void lv_test_mouse_release(void) { mouse_pressed = false; }
...
void lv_test_key_release(void) { key_pressed = false; }
...
void lv_test_encoder_add_diff(int32_t d) { diff_act += d; }
...
void lv_test_encoder_press(void) { enc_pressed = true; }

void lv_test_encoder_release(void) { enc_pressed = false; }
