...
void lv_example_anim_3(void) {
  static lv_coord_t col_dsc[] = {LV_GRID_FR(1), 200, LV_GRID_FR(1),
                                 LV_GRID_TEMPLATE_LAST};
  static lv_coord_t row_dsc[] = {30, 10, 10, LV_GRID_FR(1),
                                 LV_GRID_TEMPLATE_LAST};
...
static void page_obj_init(lv_obj_t *par) {
  ...
  lv_obj_set_style_bg_color(ginfo.anim_obj, lv_palette_main(LV_PALETTE_RED),
                            LV_PART_MAIN);
  lv_obj_set_grid_cell(ginfo.anim_obj, LV_GRID_ALIGN_START, 0, 1,
  ...
  lv_obj_set_grid_cell(ginfo.p1_label, LV_GRID_ALIGN_START, 0, 1,
                       LV_GRID_ALIGN_START, 1, 1);
  lv_obj_set_grid_cell(ginfo.p2_label, LV_GRID_ALIGN_START, 0, 1,
  ...
  lv_obj_add_event_cb(ginfo.p1_slider, slider_event_cb, LV_EVENT_VALUE_CHANGED,
                      NULL);
  lv_obj_add_event_cb(ginfo.p2_slider, slider_event_cb, LV_EVENT_VALUE_CHANGED,
                      NULL);
  lv_obj_set_grid_cell(ginfo.p1_slider, LV_GRID_ALIGN_STRETCH, 1, 1,
                       LV_GRID_ALIGN_START, 1, 1);
  lv_obj_set_grid_cell(ginfo.p2_slider, LV_GRID_ALIGN_STRETCH, 1, 1,
                       LV_GRID_ALIGN_START, 2, 1);

  ginfo.run_btn = lv_btn_create(par);
  lv_obj_add_event_cb(ginfo.run_btn, run_btn_event_handler, LV_EVENT_CLICKED,
                      NULL);
  lv_obj_t *btn_label = lv_label_create(ginfo.run_btn);
  lv_label_set_text(btn_label, LV_SYMBOL_PLAY);
  lv_obj_center(btn_label);
  lv_obj_set_grid_cell(ginfo.run_btn, LV_GRID_ALIGN_STRETCH, 2, 1,
  ...
  ginfo.ser1 = lv_chart_add_series(ginfo.chart, lv_palette_main(LV_PALETTE_RED),
  ...
  lv_obj_set_grid_cell(ginfo.chart, LV_GRID_ALIGN_STRETCH, 0, 3,
