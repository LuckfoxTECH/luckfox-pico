#include "../../lv_examples.h"
    ...
    LV_FONT_SIMSUN_16_CJK && LV_USE_BIDI
...
void lv_example_label_3(void) {
  ...
  lv_label_set_text(ltr_label, "In modern terminology, a microcontroller is "
                               "similar to a system on a chip (SoC).");
  ...
  lv_label_set_text(rtl_label, "מעבד, או בשמו המלא יחידת עיבוד מרכזית "
                               "(באנגלית: CPU - Central Processing Unit).");
  ...
  lv_label_set_text(cz_label, "嵌入式系统（Embedded "
                              "System），\n是一种嵌入机械或电气系统内部、具有专"
                              "一功能和实时计算性能的计算机系统。");
