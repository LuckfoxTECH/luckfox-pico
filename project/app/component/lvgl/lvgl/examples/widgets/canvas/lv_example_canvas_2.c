...
void lv_example_canvas_2(void) {
  ...
  static lv_color_t
      cbuf[LV_CANVAS_BUF_SIZE_INDEXED_1BIT(CANVAS_WIDTH, CANVAS_HEIGHT)];
  ...
  /*Red background (There is no dedicated alpha channel in indexed images so
   * LV_OPA_COVER is ignored)*/
