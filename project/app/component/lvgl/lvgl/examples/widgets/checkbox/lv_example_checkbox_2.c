...
void lv_example_checkbox_2(void) {
   ...
   * the `LV_EVENT_CLICKED` on the container. A variable is passed as event user
   * data where the index of the active radiobutton is saved */
  ...
  lv_obj_add_event_cb(cont1, radio_event_handler, LV_EVENT_CLICKED,
                      &active_index_1);
  ...
  lv_obj_add_event_cb(cont2, radio_event_handler, LV_EVENT_CLICKED,
                      &active_index_2);
