...
void lv_example_meter_3(void) {
  ...
  lv_meter_set_scale_ticks(meter, scale_min, 61, 1, 10,
  ...
  lv_meter_set_scale_major_ticks(meter, scale_hour, 1, 2, 20, lv_color_black(),
                                 10); /*Every tick is major*/
  lv_meter_set_scale_range(meter, scale_hour, 1, 12, 330,
  ...
  lv_meter_indicator_t *indic_min =
      lv_meter_add_needle_img(meter, scale_min, &img_hand, 5, 5);
