...
void lv_example_gridnav_3(void) {
  ...
  lv_obj_set_style_bg_color(cont_main, lv_palette_lighten(LV_PALETTE_BLUE, 5),
                            LV_STATE_FOCUSED);
  ...
  /*Create an other container with long text to show how
   * LV_GRIDNAV_CTRL_SCROLL_FIRST works*/
  lv_obj_t *cont_sub1 = lv_obj_create(cont_main);
  lv_obj_set_size(cont_sub1, lv_pct(100), 100);

  label = lv_label_create(cont_sub1);
  lv_obj_set_style_bg_color(cont_sub1, lv_palette_lighten(LV_PALETTE_RED, 5),
                            LV_STATE_FOCUSED);
  ...
  lv_label_set_text(
      ...
      "and a new objects will be focused only when an edge is reached with the "
      "scrolling.\n\n"
      "This is only some placeholder text to be sure the parent will be "
      "scrollable. \n\n"
      "Hello world!\n"
      "Hello world!\n"
      "Hello world!\n"
  ...
  /*Create a third container that can be focused with ENTER and contains an
   * other grid nav*/
  ...
  lv_obj_set_style_bg_color(cont_sub2, lv_palette_lighten(LV_PALETTE_RED, 5),
                            LV_STATE_FOCUSED);
