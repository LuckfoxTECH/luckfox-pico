...
void lv_example_scroll_5(void) {
  ...
  lv_label_set_text(
      ...
      "است "
      "که "
      "دارای حافظهٔ دسترسی تصادفی (RAM) و حافظهٔ فقط‌خواندنی "
      "(ROM)، "
      "تایمر، "
      "پورت‌های ورودی و خروجی (I/O) و درگاه ترتیبی (Serial Port "
      "پورت "
      "سریال)، "
      "درون خود تراشه است، و می‌تواند به تنهایی ابزارهای دیگر را "
      "کنترل "
      "کند. "
      "به عبارت دیگر یک میکروکنترلر، مدار مجتمع کوچکی است که از یک CPU کوچک و "
      "اجزای دیگری مانند تایمر، درگاه‌های ورودی و خروجی آنالوگ و "
      "دیجیتال "
      "و "
      "حافظه تشکیل شده‌است.");
