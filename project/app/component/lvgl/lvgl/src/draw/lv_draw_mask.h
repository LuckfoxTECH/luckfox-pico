 ...
 */
typedef lv_draw_mask_res_t (*lv_draw_mask_xcb_t)(lv_opa_t *mask_buf,
                                                 lv_coord_t abs_x,
                                                 lv_coord_t abs_y,
                                                 lv_coord_t len, void *p);
...
typedef struct {
  ...
  /*X / (1024*Y) steepness (X is 0..1023 range). What is the change of X in 1024
   * Y?*/
  int32_t xy_steep;

  /*Y / (1024*X) steepness (Y is 0..1023 range). What is the change of Y in 1024
   * X?*/
  int32_t yx_steep;

  /*Helper which stores yx_steep for flat lines and xy_steep for steep (non
   * flat) lines*/
  int32_t steep;
...
typedef _lv_draw_mask_radius_circle_dsc_t
    _lv_draw_mask_radius_circle_dsc_arr_t[LV_CIRCLE_CACHE_SIZE];
