...
#define LV_RADIUS_CIRCLE                                                       \
  0x7FFF /**< A very big radius to always draw as circle*/
...
typedef struct {
  ...
  union {
#endif
    lv_color_t bg_color; /**< First element of a gradient is a color, so it maps
                            well here*/
 ...
 */
void lv_draw_rect(struct _lv_draw_ctx_t *draw_ctx,
