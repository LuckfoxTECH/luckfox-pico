...
/**
 * Get the real text alignment from the a text alignment, base direction and a
 * text.
 * @param align     LV_TEXT_ALIGN_..., write back the calculated align here
 * (LV_TEXT_ALIGN_LEFT/RIGHT/CENTER)
 * @param base_dir  LV_BASE_DIR_..., write the calculated base dir here
 * (LV_BASE_DIR_LTR/RTL)
 * @param txt       a text, used with LV_BASE_DIR_AUTO to determine the base
 * direction
 */
 ...
 * Get the real text alignment from the a text alignment, base direction and a
 * text.
 * @param align     For LV_TEXT_ALIGN_AUTO give LV_TEXT_ALIGN_LEFT else leave
 * unchanged, write back the calculated align here
 * @param base_dir  Unused
 * @param txt       Unused
 */
static inline void lv_bidi_calculate_align(lv_text_align_t *align,
                                           lv_base_dir_t *base_dir,
                                           const char *txt) {
  LV_UNUSED(txt);
  LV_UNUSED(base_dir);
