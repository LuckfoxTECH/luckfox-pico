 ...
 * These points will be assigned to the buttons to press a specific point on the
 * screen
 * @param indev pointer to an input device
 * @param group point to a group
 */
...
/**
 * Check the current scroll direction of an input device (for
 * LV_INDEV_TYPE_POINTER and LV_INDEV_TYPE_BUTTON)
 * @param indev pointer to an input device
 ...
 * LV_INDEV_TYPE_BUTTON)
 * @param indev pointer to an input device
 * @return pointer to the currently scrolled object or NULL if no scrolling by
 * this indev
 */
