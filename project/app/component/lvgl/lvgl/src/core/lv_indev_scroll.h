...
/**
 * Handle throwing after scrolling. Called by LVGL during input device
 * processing
 * @param proc      pointer to an input device's proc field
 */
 ...
 * @return          the difference compared to the current position when the
 * throw would be finished
 */
