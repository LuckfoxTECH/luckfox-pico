...
typedef struct _lv_theme_t {
  ...
  struct _lv_theme_t
      *parent; /**< Apply the current theme's style on top of this theme.*/
  void *user_data;
 ...
 * The styles from the base them will be added before the styles of the current
 * theme. Arbitrary long chain of themes can be created by setting base themes.
