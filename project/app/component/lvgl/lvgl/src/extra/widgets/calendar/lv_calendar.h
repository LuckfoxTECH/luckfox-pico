 ...
 * dates. Only the pointer will be saved so this variable can't be local which
 ...
 *                      Only the pointer will be saved so this variable can't be
 * local which will be destroyed later.
 */
 ...
 * @return LV_RES_OK: there is a valid pressed date; LV_RES_INV: there is no
 * pressed data
 */
