 ...
 *  STATIC PROTOTYPES
 **********************/
static void lv_tileview_constructor(const lv_obj_class_t *class_p,
                                    lv_obj_t *obj);
static void lv_tileview_tile_constructor(const lv_obj_class_t *class_p,
                                         lv_obj_t *obj);
...
lv_obj_t *lv_tileview_add_tile(lv_obj_t *tv, uint8_t col_id, uint8_t row_id,
                               lv_dir_t dir) {
  LV_LOG_INFO("begin");
  create_dir = dir;
...
void lv_obj_set_tile(lv_obj_t *obj, lv_obj_t *tile_obj,
