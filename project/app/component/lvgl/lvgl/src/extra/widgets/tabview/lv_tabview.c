 ...
 *  STATIC PROTOTYPES
 **********************/
static void lv_tabview_constructor(const lv_obj_class_t *class_p,
                                   lv_obj_t *obj);
 ...
 *  STATIC VARIABLES
 **********************/
const lv_obj_class_t lv_tabview_class = {.constructor_cb =
...
lv_obj_t *lv_tabview_create(lv_obj_t *parent, lv_dir_t tab_pos,
                            lv_coord_t tab_size) {
  LV_LOG_INFO("begin");
...
lv_obj_t *lv_tabview_add_tab(lv_obj_t *obj, const char *name) {
  ...
  lv_btnmatrix_set_btn_ctrl_all(btns, LV_BTNMATRIX_CTRL_CHECKABLE |
...
static void lv_tabview_constructor(const lv_obj_class_t *class_p,
  ...
  lv_obj_add_event_cb(btnm, btns_value_changed_event_cb, LV_EVENT_VALUE_CHANGED,
                      NULL);
...
static void lv_tabview_destructor(const lv_obj_class_t *class_p,
                                  lv_obj_t *obj) {
  LV_UNUSED(class_p);
  lv_tabview_t *tabview = (lv_tabview_t *)obj;
