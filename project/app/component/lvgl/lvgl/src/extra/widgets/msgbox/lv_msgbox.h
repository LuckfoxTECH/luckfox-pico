...
#error                                                                         \
    "lv_mbox: lv_btnm is required. Enable it in lv_conf.h (LV_USE_BTNMATRIX  1) "
#endif

#if LV_USE_LABEL == 0
#error                                                                         \
    "lv_mbox: lv_label is required. Enable it in lv_conf.h (LV_USE_LABEL  1) "
#endif
 ...
 * @param parent        pointer to parent or NULL to create a full screen modal
 * message box
 * @param title         the title of the message box
 * @param txt           the text of the message box
 * @param btn_txts      the buttons as an array of texts terminated by an ""
 * element. E.g. {"btn1", "btn2", ""}
