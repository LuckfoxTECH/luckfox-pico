 ...
 *  STATIC PROTOTYPES
 **********************/
static void lv_keyboard_constructor(const lv_obj_class_t *class_p,
                                    lv_obj_t *obj);
...
static const char *const default_kb_map_lc[] = {"1#",
                                                "q",
                                                "w",
                                                "e",
                                                "r",
...
static const char *const default_kb_map_uc[] = {"1#",
                                                "Q",
                                                "W",
                                                "E",
                                                "R",
...
static const char *const default_kb_map_spec[] = {"1",
                                                  "2",
                                                  "3",
                                                  "4",
                                                  "5",
 ...
 */
void lv_keyboard_set_map(lv_obj_t *obj, lv_keyboard_mode_t mode,
                         const char *map[],
 ...
 * If a custom `event_cb` is added to the keyboard this function can be called
 * from it to handle the button clicks
...
static void lv_keyboard_constructor(const lv_obj_class_t *class_p,
  ...
  lv_obj_add_event_cb(obj, lv_keyboard_def_event_cb, LV_EVENT_VALUE_CHANGED,
                      NULL);
...
static void lv_keyboard_update_ctrl_map(lv_obj_t *obj) {
  ...
  if (keyboard->popovers) {
    ...
    lv_btnmatrix_ctrl_t *ctrl_map =
        lv_mem_alloc(btnm->btn_cnt * sizeof(lv_btnmatrix_ctrl_t));
