 ...
 *  STATIC PROTOTYPES
 **********************/
static void lv_spinner_constructor(const lv_obj_class_t *class_p,
                                   lv_obj_t *obj);
...
const lv_obj_class_t lv_spinner_class = {
    .base_class = &lv_arc_class, .constructor_cb = lv_spinner_constructor};
 ...
 */
lv_obj_t *lv_spinner_create(lv_obj_t *parent, uint32_t time,
                            uint32_t arc_length) {
  time_param = time;
