 ...
 * @param max_faces Maximum number of opened FT_Face objects managed by this
 * cache instance. Use 0 for defaults.
 * @param max_sizes Maximum number of opened FT_Size objects managed by this
 * cache instance. Use 0 for defaults.
 * @param max_bytes Maximum number of bytes to use for cached data nodes. Use 0
 * for defaults. Note that this value does not account for managed FT_Face and
 * FT_Size objects.
