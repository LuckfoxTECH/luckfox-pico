 ...
 *  STATIC PROTOTYPES
 **********************/
static void lv_checkbox_constructor(const lv_obj_class_t *class_p,
                                    lv_obj_t *obj);
static void lv_checkbox_destructor(const lv_obj_class_t *class_p,
                                   lv_obj_t *obj);
...
static void lv_checkbox_event(const lv_obj_class_t *class_p, lv_event_t *e) {
  ...
  if (code == LV_EVENT_GET_SELF_SIZE) {
    ...
    lv_point_t txt_size;
    lv_txt_get_size(&txt_size, cb->txt, font, letter_space, line_space,
...
static void lv_checkbox_draw(lv_event_t *e) {
  ...
  lv_coord_t bg_leftp =
      lv_obj_get_style_pad_left(obj, LV_PART_MAIN) + bg_border;
  lv_coord_t bg_colp = lv_obj_get_style_pad_column(obj, LV_PART_MAIN);
  ...
  lv_coord_t transf_w =
      lv_obj_get_style_transform_width(obj, LV_PART_INDICATOR);
  lv_coord_t transf_h =
      lv_obj_get_style_transform_height(obj, LV_PART_INDICATOR);
