...
typedef struct {
  ...
  uint8_t left_knob_focus : 1; /*1: with encoder now the right knob can be
                                  adjusted*/
} lv_slider_t;
 ...
 * change the value immediately
 */
static inline void lv_slider_set_left_value(lv_obj_t *obj, int32_t value,
                                            lv_anim_enable_t anim) {
 ...
 */
static inline void lv_slider_set_range(lv_obj_t *obj, int32_t min,
                                       int32_t max) {
