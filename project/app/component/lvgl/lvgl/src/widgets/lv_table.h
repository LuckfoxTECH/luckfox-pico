 ...
 * @param txt           text to display in the cell. It will be copied and saved
 * so this variable is not required after this function call.
...
/**
 * Set the value of a cell.  Memory will be allocated to store the text by the
 * table.
 * @param obj           pointer to a Table object
 * @param row           id of the row [0 .. row_cnt -1]
 * @param col           id of the column [0 .. col_cnt -1]
 ...
 * @param col       id of the column [0 .. col_cnt -1]
 * @param ctrl      OR-ed values from ::lv_table_cell_ctrl_t
 * @return          true: all control bits are set; false: not all control bits
 * are set
 */
 ...
 * @param obj       pointer to a table object
 * @param row       pointer to variable to store the selected row
 * (LV_TABLE_CELL_NONE: if no cell selected)
 * @param col       pointer to variable to store the selected column
 * (LV_TABLE_CELL_NONE: if no cell selected)
 */
