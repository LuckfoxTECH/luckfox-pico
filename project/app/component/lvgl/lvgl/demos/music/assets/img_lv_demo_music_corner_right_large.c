...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST
    LV_ATTRIBUTE_IMG_IMG_LV_DEMO_MUSIC_CORNER_2 uint8_t
        img_lv_demo_music_corner_right_map[] = {
...
#if LV_COLOR_DEPTH == 16 && LV_COLOR_16_SWAP != 0
            /*Pixel format:  Blue: 5 bit Green: 6 bit, Red: 5 bit, Alpha 8 bit
               BUT the 2  color bytes are swapped*/
            0x31,
            0x89,
            0x00,
            0x31,
            ...
            /*Pixel format:  Blue: 8 bit, Green: 8 bit, Red: 8 bit, Alpha: 8
               bit*/
            0x47,
            0x32,
            0x34,
...
const lv_img_dsc_t img_lv_demo_music_corner_right = {
