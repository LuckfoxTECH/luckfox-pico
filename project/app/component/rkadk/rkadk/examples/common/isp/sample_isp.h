...
int SAMPLE_ISP_GET_DarkAreaBoostStrth(RKADK_U32 u32CamId, unsigned int *level);
...
int SAMPLE_ISP_SET_ManualWhiteBalance(RKADK_U32 u32CamId, unsigned int u32RGain,
                                      unsigned int u32GGain,
                                      unsigned int u32BGain);
int SAMPLE_ISP_GET_WhiteBalanceGain(RKADK_U32 u32CamId, rk_aiq_wb_gain_t *gain);
...
int SAMPLE_ISP_EnableDefog(RKADK_U32 u32CamId, bool on, opMode_t mode,
                           unsigned int level);
int SAMPLE_ISP_GET_MDhzStrth(RKADK_U32 u32CamId, bool *on, unsigned int *level);
