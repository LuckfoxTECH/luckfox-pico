...
struct bss_info {
  ...
  u32 wpa : 1, wps : 1, p2p : 1, uapsd_supported : 1, wmm_used : 1,
      has_erp_value : 1, rate_11b : 1, ht : 1, short_preamble : 1,
      use_cts_prot : 1, use_short_slot : 1, ps_enabled : 1, ht_40M : 1,
      greenfiled : 1, short_gi : 1, dtim_check : 1;
...
struct status_async {
  u8 is_connected;
  u8 type; /*0: connect msg; 1: rmmod; 2: scan complet, 3:wakeup host reason,
              4:disconnect reason, 5:connect fail reason, 6:customer event*/
...
enum { DISCONN_BSS_LOST, DISCONN_HOST_DONE, DISCONN_AP_DEAUTH };
