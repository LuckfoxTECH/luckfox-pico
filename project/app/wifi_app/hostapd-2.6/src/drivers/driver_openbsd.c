...
static int wpa_driver_openbsd_get_ssid(void *priv, u8 *ssid) {
...
static int wpa_driver_openbsd_get_bssid(void *priv, u8 *bssid) {
  struct openbsd_driver_data *drv = priv;
...
static int wpa_driver_openbsd_get_capa(void *priv,
...
static int wpa_driver_openbsd_set_key(const char *ifname, void *priv,
                                      enum wpa_alg alg,
...
static void *wpa_driver_openbsd_init(void *ctx, const char *ifname) {
...
static void wpa_driver_openbsd_deinit(void *priv) {
  struct openbsd_driver_data *drv = priv;
