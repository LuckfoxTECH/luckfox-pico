...
static inline int peerkey_verify_eapol_key_mic(struct wpa_sm *sm,
...
static inline void peerkey_rx_eapol_smk(struct wpa_sm *sm, const u8 *src_addr,
                                        struct wpa_eapol_key *key,
                                        size_t extra_len, u16 key_info,
                                        u16 ver) {}
