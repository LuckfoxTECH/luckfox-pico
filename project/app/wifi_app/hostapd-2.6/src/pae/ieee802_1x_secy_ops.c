...
int secy_cp_control_protect_frames(struct ieee802_1x_kay *kay,
                                   Boolean enabled) {
...
int secy_cp_control_replay(struct ieee802_1x_kay *kay, Boolean enabled,
                           u32 win) {
  struct ieee802_1x_kay_ctx *ops;
...
int secy_get_receive_lowest_pn(struct ieee802_1x_kay *kay,
  ...
  return ops->get_receive_lowest_pn(ops->ctx, rxsa->sc->channel, rxsa->an,
                                    &rxsa->lowest_pn);
}
...
int secy_get_transmit_next_pn(struct ieee802_1x_kay *kay,
  ...
  return ops->get_transmit_next_pn(ops->ctx, txsa->sc->channel, txsa->an,
                                   &txsa->next_pn);
}
...
int secy_set_transmit_next_pn(struct ieee802_1x_kay *kay,
  ...
  return ops->set_transmit_next_pn(ops->ctx, txsa->sc->channel, txsa->an,
                                   txsa->next_pn);
}
...
int secy_create_receive_sc(struct ieee802_1x_kay *kay,
  ...
  return ops->create_receive_sc(ops->ctx, rxsc->channel, &rxsc->sci, kay->vf,
                                kay->co);
}
...
int secy_create_receive_sa(struct ieee802_1x_kay *kay,
                           struct receive_sa *rxsa) {
  struct ieee802_1x_kay_ctx *ops;
...
int secy_enable_receive_sa(struct ieee802_1x_kay *kay,
                           struct receive_sa *rxsa) {
  struct ieee802_1x_kay_ctx *ops;
