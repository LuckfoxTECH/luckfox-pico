...
ieee802_1x_mka_dump_basic_body(struct ieee802_1x_mka_basic_body *body) {
  ...
  wpa_hexdump(MSG_DEBUG, "\tMember Id.....:", body->actor_mi,
              sizeof(body->actor_mi));
  wpa_printf(MSG_DEBUG, "\tMessage Number: %d", be_to_host32(body->actor_mn));
  wpa_hexdump(MSG_DEBUG, "\tAlgo Agility..:", body->algo_agility,
...
static const char *yes_no(int val) { return val ? "Yes" : "No"; }
 ...
 */
static struct ieee802_1x_kay_peer *ieee802_1x_kay_get_potential_peer(
 ...
 */
static Boolean ieee802_1x_kay_is_in_potential_peer(
    struct ieee802_1x_mka_participant *participant, const u8 *mi) {
 ...
 */
static Boolean
ieee802_1x_kay_is_in_live_peer(struct ieee802_1x_mka_participant *participant,
                               const u8 *mi) {
...
ieee802_1x_kay_get_peer_sci(struct ieee802_1x_mka_participant *participant,
  ...
  dl_list_for_each(peer, &participant->live_peers, struct ieee802_1x_kay_peer,
                   list) {
 ...
 */
static struct receive_sa *ieee802_1x_kay_init_receive_sa(struct receive_sc *psc,
                                                         u8 an, u32 lowest_pn,
                                                         struct data_key *key) {
...
static void ieee802_1x_kay_deinit_receive_sa(struct receive_sa *psa) {
  psa->pkey = NULL;
  wpa_printf(MSG_DEBUG, "KaY: Delete receive SA(an: %hhu) of SC", psa->an);
 ...
 **/
static void
ieee802_1x_kay_deinit_receive_sc(struct ieee802_1x_mka_participant *participant,
                                 struct receive_sc *psc) {
...
static struct ieee802_1x_kay_peer *ieee802_1x_kay_create_peer(const u8 *mi,
                                                              u32 mn) {
  struct ieee802_1x_kay_peer *peer;
 ...
 */
static struct ieee802_1x_kay_peer *ieee802_1x_kay_create_potential_peer(
 ...
 */
static Boolean ieee802_1x_mka_basic_body_present(
    struct ieee802_1x_mka_participant *participant) {
  return TRUE;
}
 ...
 */
static int ieee802_1x_mka_basic_body_length(
    struct ieee802_1x_mka_participant *participant) {
  int length;
 ...
 */
static int
ieee802_1x_mka_encode_basic_body(struct ieee802_1x_mka_participant *participant,
                                 struct wpabuf *buf) {
  ...
  os_memcpy(body->algo_agility, kay->algo_agility, sizeof(body->algo_agility));
...
ieee802_1x_mka_decode_basic_body(struct ieee802_1x_kay *kay, const u8 *mka_msg,
  ...
  if (!peer) {
    ...
    peer = ieee802_1x_kay_create_potential_peer(participant, body->actor_mi,
 ...
 */
static Boolean ieee802_1x_mka_live_peer_body_present(
    struct ieee802_1x_mka_participant *participant) {
 ...
 */
static int ieee802_1x_mka_get_live_peer_length(
    struct ieee802_1x_mka_participant *participant) {
  int len = MKA_HDR_LEN;
  struct ieee802_1x_kay_peer *peer;

  dl_list_for_each(peer, &participant->live_peers, struct ieee802_1x_kay_peer,
                   list) len += sizeof(struct ieee802_1x_mka_peer_id);
 ...
 */
static int ieee802_1x_mka_encode_live_peer_body(
    struct ieee802_1x_mka_participant *participant, struct wpabuf *buf) {
 ...
 */
static Boolean ieee802_1x_mka_potential_peer_body_present(
    struct ieee802_1x_mka_participant *participant) {
 ...
 */
static int ieee802_1x_mka_get_potential_peer_length(
    struct ieee802_1x_mka_participant *participant) {
  int len = MKA_HDR_LEN;
  struct ieee802_1x_kay_peer *peer;

  dl_list_for_each(peer, &participant->potential_peers,
                   struct ieee802_1x_kay_peer, list) len +=
 ...
 */
static int ieee802_1x_mka_encode_potential_peer_body(
    struct ieee802_1x_mka_participant *participant, struct wpabuf *buf) {
  struct ieee802_1x_mka_peer_body *body;
  struct ieee802_1x_kay_peer *peer;
  unsigned int length;
...
ieee802_1x_mka_i_in_peerlist(struct ieee802_1x_mka_participant *participant,
  ...
  for (pos = mka_msg, left_len = msg_len;
       ...
       left_len -= body_len + MKA_HDR_LEN, pos += body_len + MKA_HDR_LEN) {
    ...
    if (left_len < (MKA_HDR_LEN + body_len + DEFAULT_ICV_LEN)) {
      wpa_printf(MSG_ERROR,
                 "KaY: MKA Peer Packet Body Length (%zu bytes) is less than "
                 "the Parameter Set Header Length (%zu bytes) + the Parameter "
                 "Set Body Length (%zu bytes) + %d bytes of ICV",
                 left_len, MKA_HDR_LEN, body_len, DEFAULT_ICV_LEN);
      continue;
    }

    if ((body_len % 16) != 0) {
      wpa_printf(MSG_ERROR,
                 "KaY: MKA Peer Packet Body Length (%zu bytes) should be a "
    ...
    for (i = 0; i < body_len; i += sizeof(struct ieee802_1x_mka_peer_id)) {
      ...
      peer_mi = (const struct ieee802_1x_mka_peer_id *)(pos + MKA_HDR_LEN + i);
...
static int ieee802_1x_mka_decode_live_peer_body(
    struct ieee802_1x_mka_participant *participant, const u8 *peer_msg,
    size_t msg_len) {
  ...
  is_included = ieee802_1x_kay_is_in_live_peer(participant,
  ...
  for (i = 0; i < body_len; i += sizeof(struct ieee802_1x_mka_peer_id)) {
    ...
    if (peer) {
      peer->mn = peer_mn;
      peer->expire = time(NULL) + MKA_LIFE_TIME / 1000;
    } else if (!ieee802_1x_kay_create_potential_peer(participant, peer_mi->mi,
                                                     peer_mn)) {
      return -1;
    }
  }
 ...
 */
static int ieee802_1x_mka_decode_potential_peer_body(
    struct ieee802_1x_mka_participant *participant, const u8 *peer_msg,
    size_t msg_len) {
  const struct ieee802_1x_mka_hdr *hdr;
  size_t body_len;
  ...
  for (i = 0; i < body_len; i += sizeof(struct ieee802_1x_mka_peer_id)) {
    ...
    peer_mi = (struct ieee802_1x_mka_peer_id *)(peer_msg + MKA_HDR_LEN + i);
    peer_mn = be_to_host32(peer_mi->mn);
 ...
 */
static Boolean ieee802_1x_mka_sak_use_body_present(
    struct ieee802_1x_mka_participant *participant) {
 ...
 */
static int ieee802_1x_mka_get_sak_use_length(
    struct ieee802_1x_mka_participant *participant) {
 ...
 *
 */
static u32 ieee802_1x_mka_get_lpn(struct ieee802_1x_mka_participant *principal,
 ...
 */
static int ieee802_1x_mka_encode_sak_use_body(
    struct ieee802_1x_mka_participant *participant, struct wpabuf *buf) {
 ...
 */
static int ieee802_1x_mka_decode_sak_use_body(
  ...
  if ((body_len != 0) && (body_len < 40)) {
    wpa_printf(MSG_ERROR,
               "KaY: MKA Use SAK Packet Body Length (%zu bytes) should be 0, "
               "40, or more octets",
               body_len);
    return -1;
  }
  ...
  if (body->delay_protect &&
    ...
    wpa_printf(MSG_WARNING, "KaY: Lowest packet number should greater than 0 "
                            "when delay_protect is TRUE");
    return -1;
  }
  ...
  found = FALSE;
  dl_list_for_each(txsa, &participant->txsc->sa_list, struct transmit_sa,
                   list) {
 ...
 */
static Boolean ieee802_1x_mka_dist_sak_body_present(
    struct ieee802_1x_mka_participant *participant) {
 ...
 */
static int ieee802_1x_mka_get_dist_sak_length(
    struct ieee802_1x_mka_participant *participant) {
  int length = MKA_HDR_LEN;
 ...
 */
static int ieee802_1x_mka_encode_dist_sak_body(
    struct ieee802_1x_mka_participant *participant, struct wpabuf *buf) {
  ...
  if (aes_wrap(participant->kek.key, 16, cipher_suite_tbl[cs_index].sak_len / 8,
 ...
 */
static int ieee802_1x_mka_decode_dist_sak_body(
    struct ieee802_1x_mka_participant *participant, const u8 *mka_msg,
    size_t msg_len) {
  struct ieee802_1x_mka_hdr *hdr;
  struct ieee802_1x_mka_dist_sak_body *body;
  ...
  ieee802_1x_mka_dump_dist_sak_body(body);
  dl_list_for_each(sa_key, &participant->sak_list, struct data_key, list) {
    if (os_memcmp(sa_key->key_identifier.mi, participant->current_peer_id.mi,
                  MI_LEN) == 0 &&
 ...
 */
static Boolean ieee802_1x_mka_icv_body_present(
    struct ieee802_1x_mka_participant *participant) {
  return TRUE;
}
 ...
 */
static int ieee802_1x_mka_decode_dist_cak_body(
    struct ieee802_1x_mka_participant *participant, const u8 *mka_msg,
    size_t msg_len) {
  struct ieee802_1x_mka_hdr *hdr;
  size_t body_len;
  ...
  if (body_len < 28) {
    wpa_printf(MSG_ERROR,
               "KaY: MKA Use SAK Packet Body Length (%zu bytes) should be 28 "
               "or more octets",
               body_len);
    return -1;
  }
 ...
 */
static int
ieee802_1x_mka_decode_kmd_body(struct ieee802_1x_mka_participant *participant,
                               const u8 *mka_msg, size_t msg_len) {
  struct ieee802_1x_mka_hdr *hdr;
  size_t body_len;
  ...
  if (body_len < 5) {
    wpa_printf(MSG_ERROR,
               "KaY: MKA Use SAK Packet Body Length (%zu bytes) should be 5 or "
               "more octets",
               body_len);
    return -1;
  }
 ...
 */
static int ieee802_1x_kay_generate_new_sak(
    struct ieee802_1x_mka_participant *participant) {
  struct data_key *sa_key = NULL;
  struct ieee802_1x_kay_peer *peer;
  struct ieee802_1x_kay *kay = participant->kay;
  ...
  if (key_len == 16) {
    ieee802_1x_sak_128bits_aes_cmac(participant->cak.key, context, ctx_len,
                                    key);
  } else if (key_len == 32) {
    ieee802_1x_sak_128bits_aes_cmac(participant->cak.key, context, ctx_len,
                                    key);
 ...
 */
static int ieee802_1x_kay_elect_key_server(
    struct ieee802_1x_mka_participant *participant) {
  struct ieee802_1x_kay_peer *peer;
 ...
 */
static int ieee802_1x_kay_decide_macsec_use(
    struct ieee802_1x_mka_participant *participant) {
  struct ieee802_1x_kay *kay = participant->kay;
  struct ieee802_1x_kay_peer *peer;
 ...
 */
static int ieee802_1x_participant_send_mkpdu(
    struct ieee802_1x_mka_participant *participant) {
  struct wpabuf *buf;
  struct ieee802_1x_kay *kay = participant->kay;
  size_t length = 0;
...
static void ieee802_1x_participant_timer(void *eloop_ctx, void *timeout_ctx) {
  ...
  dl_list_for_each_safe(peer, pre_peer, &participant->live_peers,
    ...
    if (now > peer->expire) {
      ...
      wpa_hexdump(MSG_DEBUG, "\tMI: ", peer->mi, sizeof(peer->mi));
      wpa_printf(MSG_DEBUG, "\tMN: %d", peer->mn);
      dl_list_for_each_safe(rxsc, pre_rxsc, &participant->rxsc_list,
  ...
  if (lp_changed) {
    if (dl_list_empty(&participant->live_peers)) {
      ...
      kay->orx_kn = 0;
      kay->orx_an = 0;
      dl_list_for_each_safe(txsa, pre_txsa, &participant->txsc->sa_list,
  ...
  eloop_register_timeout(MKA_HELLO_TIME / 1000, 0, ieee802_1x_participant_timer,
                         participant, NULL);
...
ieee802_1x_kay_init_transmit_sa(struct transmit_sc *psc, u8 an, u32 next_PN,
  ...
  wpa_printf(
      MSG_DEBUG,
      "KaY: Create transmit SA(an: %hhu, next_PN: %u) of SC(channel: %d)", an,
      next_PN, psc->channel);
...
static void ieee802_1x_kay_deinit_transmit_sa(struct transmit_sa *psa) {
  psa->pkey = NULL;
  wpa_printf(MSG_DEBUG, "KaY: Delete transmit SA(an: %hhu) of SC", psa->an);
  dl_list_del(&psa->list);
  os_free(psa);
}
 ...
 */
static void ieee802_1x_kay_deinit_transmit_sc(
...
int ieee802_1x_kay_set_old_sa_attr(struct ieee802_1x_kay *kay,
                                   struct ieee802_1x_mka_ki *oki, u8 oan,
                                   Boolean otx, Boolean orx) {
  struct ieee802_1x_mka_participant *principal;
...
int ieee802_1x_kay_create_sas(struct ieee802_1x_kay *kay,
  ...
  txsa = ieee802_1x_kay_init_transmit_sa(principal->txsc, latest_sak->an, 1,
                                         latest_sak);
  if (!txsa)
    return -1;
...
int ieee802_1x_kay_delete_sas(struct ieee802_1x_kay *kay,
  ...
  dl_list_for_each(rxsc, &principal->rxsc_list, struct receive_sc, list) {
    dl_list_for_each_safe(rxsa, pre_rxsa, &rxsc->sa_list, struct receive_sa,
                          list) {
      if (is_ki_equal(&rxsa->pkey->key_identifier, ki)) {
  ...
  /* remove the sak */
  dl_list_for_each_safe(sa_key, pre_key, &principal->sak_list, struct data_key,
                        list) {
    if (is_ki_equal(&sa_key->key_identifier, ki)) {
...
static int ieee802_1x_kay_mkpdu_sanity_check(struct ieee802_1x_kay *kay,
  ...
  if (mka_msg_len < MKA_HDR_LEN + body_len + DEFAULT_ICV_LEN) {
    wpa_printf(MSG_ERROR,
               "KaY: Received EAPOL-MKA Packet Body Length (%zu bytes) is less "
               "than the Basic Parameter Set Header Length (%zu bytes) + the "
               "Basic Parameter Set Body Length (%zu bytes) + %d bytes of ICV",
               mka_msg_len, MKA_HDR_LEN, body_len, DEFAULT_ICV_LEN);
    return -1;
  }
  ...
  if (mka_alg_tbl[kay->mka_algindex].icv_hash(
          participant->ick.key, buf,
          len - mka_alg_tbl[kay->mka_algindex].icv_len, icv)) {
    wpa_printf(MSG_ERROR, "KaY: omac1_aes_128 failed");
    return -1;
  }

  msg_icv =
      ieee802_1x_mka_decode_icv_body(participant, (u8 *)mka_hdr, mka_msg_len);
  if (!msg_icv) {
    wpa_printf(MSG_ERROR, "KaY: No ICV");
    return -1;
  }
  if (os_memcmp_const(msg_icv, icv, mka_alg_tbl[kay->mka_algindex].icv_len) !=
      0) {
...
static int ieee802_1x_kay_decode_mkpdu(struct ieee802_1x_kay *kay,
  ...
  for (; left_len > MKA_HDR_LEN + DEFAULT_ICV_LEN;
       pos += body_len + MKA_HDR_LEN, left_len -= body_len + MKA_HDR_LEN) {
    hdr = (struct ieee802_1x_mka_hdr *)pos;
    body_len = get_mka_param_body_len(hdr);
    body_type = get_mka_param_body_type(hdr);
    ...
    if (body_type < ARRAY_SIZE(mka_body_handler) &&
      ...
      mka_body_handler[body_type].body_rx(participant, pos, left_len);
    } else {
      wpa_printf(MSG_ERROR,
...
static void kay_l2_receive(void *ctx, const u8 *src_addr, const u8 *buf,
  ...
  eapol_hdr = (struct ieee802_1x_hdr *)(eth_hdr + 1);
  if (len !=
      sizeof(*eth_hdr) + sizeof(*eapol_hdr) + be_to_host16(eapol_hdr->length)) {
...
struct ieee802_1x_kay *ieee802_1x_kay_init(struct ieee802_1x_kay_ctx *ctx,
  ...
  if (policy == DO_NOT_SECURE) {
    ...
    kay->l2_mka =
        l2_packet_init(kay->if_name, NULL, ETH_P_PAE, kay_l2_receive, kay, 1);
    if (kay->l2_mka == NULL) {
      wpa_printf(
          MSG_WARNING,
 ...
 */
struct ieee802_1x_mka_participant *ieee802_1x_kay_create_mka(
    struct ieee802_1x_kay *kay, struct mka_key_name *ckn, struct mka_key *cak,
    u32 life, enum mka_created_mode mode, Boolean is_authenticator) {
  struct ieee802_1x_mka_participant *participant;
  unsigned int usecs;
  ...
  participant->txsc =
      ieee802_1x_kay_init_transmit_sc(&kay->actor_sci, kay->sc_ch);
  ...
  if (mka_alg_tbl[kay->mka_algindex].kek_trfm(
          participant->cak.key, participant->ckn.name, participant->ckn.len,
          participant->kek.key)) {
    wpa_printf(MSG_ERROR, "KaY: Derived KEK failed");
    goto fail;
  }
  wpa_hexdump_key(MSG_DEBUG, "KaY: Derived KEK", participant->kek.key,
                  participant->kek.len);

  /* to derive ICK from CAK and CKN */
  participant->ick.len = mka_alg_tbl[kay->mka_algindex].ick_len;
  if (mka_alg_tbl[kay->mka_algindex].ick_trfm(
          participant->cak.key, participant->ckn.name, participant->ckn.len,
          participant->ick.key)) {
    wpa_printf(MSG_ERROR, "KaY: Derived ICK failed");
    goto fail;
  }
  wpa_hexdump_key(MSG_DEBUG, "KaY: Derived ICK", participant->ick.key,
                  participant->ick.len);
  ...
  eloop_register_timeout(0, usecs, ieee802_1x_participant_timer, participant,
                         NULL);
...
void ieee802_1x_kay_delete_mka(struct ieee802_1x_kay *kay,
  ...
  if (!participant) {
    wpa_hexdump(MSG_DEBUG, "KaY: participant is not found", ckn->name,
                ckn->len);
    return;
  }
...
void ieee802_1x_kay_mka_participate(struct ieee802_1x_kay *kay,
                                    struct mka_key_name *ckn, Boolean status) {
  struct ieee802_1x_mka_participant *participant;
