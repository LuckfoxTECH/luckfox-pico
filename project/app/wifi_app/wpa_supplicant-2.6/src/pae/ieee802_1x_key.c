...
int ieee802_1x_cak_128bits_aes_cmac(const u8 *msk, const u8 *mac1,
  ...
  return aes_kdf_128(msk, "IEEE8021 EAP CAK", context, sizeof(context) * 8, 128,
                     cak);
}
...
int ieee802_1x_ckn_128bits_aes_cmac(const u8 *msk, const u8 *mac1,
  ...
  res = aes_kdf_128(msk, "IEEE8021 EAP CKN", context, ctx_len * 8, 128, ckn);
  os_free(context);
  return res;
}
...
int ieee802_1x_kek_128bits_aes_cmac(const u8 *cak, const u8 *ckn,
  ...
  return aes_kdf_128(cak, "IEEE8021 KEK", context, sizeof(context) * 8, 128,
                     kek);
}
...
int ieee802_1x_ick_128bits_aes_cmac(const u8 *cak, const u8 *ckn,
  ...
  return aes_kdf_128(cak, "IEEE8021 ICK", context, sizeof(context) * 8, 128,
                     ick);
}
