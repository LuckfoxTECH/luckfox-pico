...
static inline int rsn_preauth_scan_results(struct wpa_sm *sm) { return -1; }

static inline void rsn_preauth_scan_result(struct wpa_sm *sm, const u8 *bssid,
                                           const u8 *ssid, const u8 *rsn) {}

static inline void pmksa_candidate_add(struct wpa_sm *sm, const u8 *bssid,
...
static inline int rsn_preauth_in_progress(struct wpa_sm *sm) { return 0; }
