...
static const u8 dh_group1_order[96] = {
    ...
    0xD3, 0x1D, 0x1B, 0x10, 0x7F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
...
static const u8 dh_group2_order[128] = {
    ...
    0xBE, 0x25, 0x8F, 0xF3, 0x24, 0x94, 0x33, 0x28, 0xF6, 0x73, 0x29, 0xC0,
    0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
...
static const u8 dh_group22_order[] = {0xF5, 0x18, 0xAA, 0x87, 0x81, 0xA8, 0xDF,
                                      0x27, 0x8A, 0xBA, 0x4E, 0x7D, 0x64, 0xB7,
                                      0xCB, 0x9D, 0x49, 0x46, 0x23, 0x53};
...
static const u8 dh_group23_prime[] = {
    ...
    0x0C, 0x10, 0xE6, 0x4F};
static const u8 dh_group23_order[] = {0x80, 0x1C, 0x0D, 0x34, 0xC5, 0x8D, 0x93,
                                      0xFE, 0x99, 0x71, 0x77, 0x10, 0x1F, 0x80,
                                      0x53, 0x5A, 0x47, 0x38, 0xCE, 0xBC, 0xBF,
                                      0x38, 0x9A, 0x99, 0xB3, 0x63, 0x71, 0xEB};
...
static const struct dh_group dh_groups[] = {
    DH_GROUP(5, 1),
#ifdef ALL_DH_GROUPS
    DH_GROUP(1, 1),  DH_GROUP(2, 1),  DH_GROUP(14, 1), DH_GROUP(15, 1),
    DH_GROUP(16, 1), DH_GROUP(17, 1), DH_GROUP(18, 1), DH_GROUP(22, 0),
    DH_GROUP(23, 0), DH_GROUP(24, 0)
#endif /* ALL_DH_GROUPS */
};
...
struct wpabuf *dh_init(const struct dh_group *dh, struct wpabuf **priv) {
  ...
  *priv = wpabuf_alloc(dh->prime_len);
  ...
  if (crypto_mod_exp(dh->generator, dh->generator_len, wpabuf_head(*priv),
                     wpabuf_len(*priv), dh->prime, dh->prime_len,
                     wpabuf_mhead(pv), &pv_len) < 0) {
...
struct wpabuf *dh_derive_shared(const struct wpabuf *peer_public,
  ...
  if (crypto_mod_exp(wpabuf_head(peer_public), wpabuf_len(peer_public),
                     ...
                     dh->prime, dh->prime_len, wpabuf_mhead(shared),
                     &shared_len) < 0) {
