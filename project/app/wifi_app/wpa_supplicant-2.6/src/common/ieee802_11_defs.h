...
#define VHT_CAP_RXSTBC_MASK ((u32)BIT(8) | BIT(9) | BIT(10))
...
#define VHT_CAP_SOUNDING_DIMENSION_MAX ((u32)BIT(16) | BIT(17) | BIT(18))
...
#define VHT_CAP_MAX_A_MPDU_LENGTH_EXPONENT_MAX                                 \
  ((u32)BIT(23) | BIT(24) | BIT(25))
...
#define OUI_MICROSOFT                                                          \
  0x0050f2 /* Microsoft (also used in Wi-Fi specs)                             \
            * 00:50:F2 */
...
enum plink_action_field { PLINK_OPEN = 1, PLINK_CONFIRM, PLINK_CLOSE };
