...
enum qca_wlan_vendor_attr_acs_offload {
  ...
  QCA_WLAN_VENDOR_ATTR_ACS_MAX = QCA_WLAN_VENDOR_ATTR_ACS_AFTER_LAST - 1
};
...
enum qca_vendor_attr_tsf_cmd {
  ...
  QCA_WLAN_VENDOR_ATTR_TSF_MAX = QCA_WLAN_VENDOR_ATTR_TSF_AFTER_LAST - 1
};
...
enum qca_vendor_attr_wisa_cmd {
  ...
  QCA_WLAN_VENDOR_ATTR_WISA_MAX = QCA_WLAN_VENDOR_ATTR_WISA_AFTER_LAST - 1
};
...
enum qca_wlan_vendor_attr_scan {
  ...
  QCA_WLAN_VENDOR_ATTR_SCAN_MAX = QCA_WLAN_VENDOR_ATTR_SCAN_AFTER_LAST - 1
};
...
enum qca_wlan_vendor_attr_config {
   ...
   * current_avg = ((beacon_TSF - TBTT) * factor + previous_avg * (0x10000 -
   * factor) ) / 0x10000 For instance, when evaluating leaky APs: current_avg =
   * ((num frame received within guard time) * factor + previous_avg * (0x10000
   * - factor)) / 0x10000
   */
  ...
  QCA_WLAN_VENDOR_ATTR_CONFIG_MAX = QCA_WLAN_VENDOR_ATTR_CONFIG_AFTER_LAST - 1,
};
...
enum qca_wlan_gpio_attr {
  ...
  QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_MAX = QCA_WLAN_VENDOR_ATTR_GPIO_PARAM_LAST - 1
};
