...
#define MAX_SCAN_ID 16
  ...
  void (*pending_action_tx_status_cb)(
      struct wpa_supplicant *wpa_s, unsigned int freq, const u8 *dst,
      const u8 *src, const u8 *bssid, const u8 *data, size_t data_len,
  ...
  enum { NORMAL_PD, AUTO_PD_GO_NEG, AUTO_PD_JOIN, AUTO_PD_ASP } pending_pd_use;
...
#define MAC_ADDR_RAND_ALL                                                      \
  (MAC_ADDR_RAND_SCAN | MAC_ADDR_RAND_SCHED_SCAN | MAC_ADDR_RAND_PNO)
