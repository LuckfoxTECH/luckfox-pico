 ...
 */
CGICC_API bool stringsAreEqual(const std::string &s1, const std::string &s2);
 ...
 * \return \c true if the strings are equal, \c false if they are not
 */
CGICC_API bool stringsAreEqual(const std::string &ss1, const std::string &ss2,
                               size_t n);
 ...
 */
CGICC_API std::string form_urldecode(const std::string &src);
 ...
 * \return The converted string
 */
CGICC_API std::string form_urlencode(const std::string &src);
 ...
 */
CGICC_API std::string charToHex(char c);
 ...
 */
CGICC_API char hexToChar(char first, char second);
 ...
 */
inline std::string extractBetween(const std::string &datas,
