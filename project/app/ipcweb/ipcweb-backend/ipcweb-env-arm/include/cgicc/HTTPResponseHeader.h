...
public:
   ...
   */
  HTTPResponseHeader(const std::string &http_version, int status_code,
   ...
   * \return A reference to this
   */
  HTTPResponseHeader &addHeader(const std::string &name,
   ...
   */
  inline const std::vector<std::string> &getHeaders() const { return fHeaders; }
  //@}
   ...
   */
  inline const std::string &getHTTPVersion() const { return fHTTPVersion; }
   ...
   */
  inline int getStatusCode() const { return fStatusCode; }
   ...
   */
  inline std::string getReasonPhrase() const { return fReasonPhrase; }
  //@}
   ...
   * \return A reference to this
   */
  inline HTTPResponseHeader &getHTTPVersion(const std::string &http_version) {
    fHTTPVersion = http_version;
    return *this;
  }
   ...
   * \return A reference to this
   */
  inline HTTPResponseHeader &getStatusCode(int status_code) {
   ...
   * \return A reference to this
   */
  inline HTTPResponseHeader &getReasonPhrase(const std::string &reason_phrase) {
    fReasonPhrase = reason_phrase;
    return *this;
  }
  //@}
