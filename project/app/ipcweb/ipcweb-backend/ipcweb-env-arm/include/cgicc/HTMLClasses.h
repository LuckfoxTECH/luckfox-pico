...
#define TAG(name, tag)                                                         \
  class name##Tag {                                                            \
  public:                                                                      \
    inline static const char *getName() { return tag; }                        \
  }
...
#define ATOMIC_ELEMENT(name, tag)                                              \
  TAG(name, tag);                                                              \
  typedef HTMLAtomicElement<name##Tag> name
...
#define BOOLEAN_ELEMENT(name, tag)                                             \
  TAG(name, tag);                                                              \
  typedef HTMLBooleanElement<name##Tag> name
...
class nullTag {
public:
  inline static const char *getName() { return 0; }
};
