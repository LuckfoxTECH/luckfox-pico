 ...
 */
template <class Tag> class HTMLBooleanElement : public HTMLElement {
public:
  // ============================================================
   ...
   *
   */
  HTMLBooleanElement() : HTMLElement(0, 0, 0, eBoolean) {}
...
template <class Tag> bool cgicc::HTMLBooleanElement<Tag>::sState = false;
