...
public:
   ...
   */
  inline bool operator!=(const CgiEnvironment &env) const {
    return !operator==(env);
  }

#ifdef WIN32
  /* Dummy operator for MSVC++ */
  inline bool operator<(const CgiEnvironment &env) const { return false; }
#endif
   ...
   */
  inline std::string getServerSoftware() const { return fServerSoftware; }
   ...
   */
  inline std::string getServerName() const { return fServerName; }
   ...
   */
  inline std::string getGatewayInterface() const { return fGatewayInterface; }
   ...
   */
  inline std::string getServerProtocol() const { return fServerProtocol; }
   ...
   */
  inline unsigned long getServerPort() const { return fServerPort; }
   ...
   */
  inline bool usingHTTPS() const { return fUsingHTTPS; }
  //@}
   ...
   * \see getCookieList
   */
  inline std::string getCookies() const { return fCookie; }
   ...
   * \see HTTPCookie
   */
  inline const std::vector<HTTPCookie> &getCookieList() const {
    return fCookies;
  }
   ...
   */
  inline std::string getRequestMethod() const { return fRequestMethod; }
   ...
   */
  inline std::string getPathInfo() const { return fPathInfo; }
   ...
   */
  inline std::string getPathTranslated() const { return fPathTranslated; }
   ...
   */
  inline std::string getScriptName() const { return fScriptName; }
   ...
   */
  inline std::string getQueryString() const { return fQueryString; }
   ...
   */
  inline unsigned long getContentLength() const { return fContentLength; }
   ...
   * \see getContentType
   */
  inline std::string getContentType() const { return fContentType; }
   ...
   */
  inline std::string getPostData() const { return fPostData; }
  //@}
   ...
   */
  inline std::string getReferrer() const { return fReferrer; }
  //@}
   ...
   */
  inline std::string getRemoteHost() const { return fRemoteHost; }
   ...
   */
  inline std::string getRemoteAddr() const { return fRemoteAddr; }
   ...
   */
  inline std::string getAuthType() const { return fAuthType; }
   ...
   */
  inline std::string getRemoteUser() const { return fRemoteUser; }
   ...
   */
  inline std::string getRemoteIdent() const { return fRemoteIdent; }
   ...
   */
  inline std::string getAccept() const { return fAccept; }
   ...
   */
  inline std::string getUserAgent() const { return fUserAgent; }
  //@}
   ...
   */
  inline std::string getRedirectRequest() const { return fRedirectRequest; }
   ...
   */
  inline std::string getRedirectURL() const { return fRedirectURL; }
   ...
   */
  inline std::string getRedirectStatus() const { return fRedirectStatus; }
  //@}
...
private:
  ...
  void readEnvironmentVariables(CgiInput *input);
