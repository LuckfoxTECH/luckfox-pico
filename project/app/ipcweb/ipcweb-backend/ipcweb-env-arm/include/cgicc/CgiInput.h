...
public:
   ...
   */
  inline CgiInput(const CgiInput &input) { operator=(input); }
   ...
   * \return \c true
   */
  inline bool operator==(const CgiInput & /*input*/) const { return true; }
   ...
   * \return \c false
   */
  inline bool operator!=(const CgiInput &input) const {
   ...
   */
  inline CgiInput &operator=(const CgiInput & /*input*/) { return *this; }
  //@}
