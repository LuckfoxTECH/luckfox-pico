 ...
 *
 *  Desc:   声明对 buffer_handle_t 实例的 get metadata,
 import_buffer/free_buffer, lock_buffer/unlock_buffer 等接口.
...
status_t lock(buffer_handle_t bufferHandle, uint64_t usage, int x, int y, int w,
              int h, void **outData);
