...
IM_API rga_buffer_handle_t importbuffer_virtualaddr(void *va,
                                                    im_handle_param_t *param);
IM_API rga_buffer_handle_t importbuffer_physicaladdr(uint64_t pa,
                                                     im_handle_param_t *param);
...
IM_API rga_buffer_t wrapbuffer_handle_t(rga_buffer_handle_t handle, int width,
...
IM_API rga_buffer_t wrapbuffer_virtualaddr_t(void *vir_addr, int width,
                                             int height, int wstride,
                                             int hstride, int format);
IM_API rga_buffer_t wrapbuffer_physicaladdr_t(void *phy_addr, int width,
                                              int height, int wstride,
                                              int hstride, int format);
IM_API rga_buffer_t wrapbuffer_fd_t(int fd, int width, int height, int wstride,
                                    int hstride, int format);
...
#define imcheck(src, dst, src_rect, dst_rect, ...)                             \
  ({                                                                           \
    ...
    int __argc = sizeof(__args) / sizeof(int);                                 \
    if (__argc == 0) {                                                         \
      rga_check_perpare((rga_buffer_t *)(&src), (rga_buffer_t *)(&dst),        \
                        (rga_buffer_t *)(&__pat), (im_rect *)(&src_rect),      \
                        (im_rect *)(&dst_rect), (im_rect *)(&__pat_rect), 0);  \
      __ret = imcheck_t(src, dst, __pat, src_rect, dst_rect, __pat_rect, 0);   \
    } else if (__argc == 1) {                                                  \
      rga_check_perpare((rga_buffer_t *)(&src), (rga_buffer_t *)(&dst),        \
                        (rga_buffer_t *)(&__pat), (im_rect *)(&src_rect),      \
                        (im_rect *)(&dst_rect), (im_rect *)(&__pat_rect),      \
                        __args[0]);                                            \
  ...
  ({                                                                           \
    ...
    if (__argc == 0) {                                                         \
      rga_check_perpare((rga_buffer_t *)(&src), (rga_buffer_t *)(&dst),        \
                        ...
                        (im_rect *)(&dst_rect), (im_rect *)(&pat_rect), 0);    \
...
IM_API void rga_check_perpare(rga_buffer_t *src, rga_buffer_t *dst,
                              rga_buffer_t *pat, im_rect *src_rect,
                              im_rect *dst_rect, im_rect *pat_rect,
                              int mode_usage);
IM_API IM_STATUS imcheck_t(const rga_buffer_t src, const rga_buffer_t dst,
...
IM_API IM_STATUS imcrop_t(const rga_buffer_t src, rga_buffer_t dst,
...
IM_API IM_STATUS imrotate_t(const rga_buffer_t src, rga_buffer_t dst,
...
IM_API IM_STATUS imflip_t(const rga_buffer_t src, rga_buffer_t dst, int mode,
                          int sync);
...
IM_API IM_STATUS impalette_t(rga_buffer_t src, rga_buffer_t dst,
...
IM_API IM_STATUS imtranslate_t(const rga_buffer_t src, rga_buffer_t dst, int x,
                               int y, int sync);
...
IM_API IM_STATUS imblend_t(const rga_buffer_t srcA, const rga_buffer_t srcB,
...
IM_API IM_STATUS imcolorkey_t(const rga_buffer_t src, rga_buffer_t dst,
...
IM_API IM_STATUS imcvtcolor_t(rga_buffer_t src, rga_buffer_t dst, int sfmt,
...
IM_API IM_STATUS imquantize_t(const rga_buffer_t src, rga_buffer_t dst,
...
IM_API IM_STATUS imrop_t(const rga_buffer_t src, rga_buffer_t dst, int rop_code,
                         int sync);
