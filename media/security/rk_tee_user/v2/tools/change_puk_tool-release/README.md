...
2.以上替换的公钥是用于OPTEE验证TA应用合法性的，用户在生成新密钥后也需要替换optee_test/export-ta_arm32/keys/oem_privkey.pem和
	optee_test/export-ta_arm64/keys/oem_privkey.pem并重新编译TA，该密钥在编译TA时会对TA重新进行签名。