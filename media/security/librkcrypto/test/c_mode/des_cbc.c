...
int rk_des_cbc_encrypt(const unsigned char *in, unsigned char *out,
  ...
  if (enc) {
    ...
    case 8:
      ...
      rk_crypto_cbc128_encrypt((void *)&ctx, in, out, length, ivec,
                               rk_des_crypt_ecb);
      break;
    case 16:
      rk_des3_set2key_enc(&ctx3, key);
      rk_crypto_cbc128_encrypt((void *)&ctx3, in, out, length, ivec,
                               rk_des3_crypt_ecb);
      break;
    case 24:
    ...
    case 8:
      ...
      rk_crypto_cbc128_decrypt((void *)&ctx, in, out, length, ivec,
                               rk_des_crypt_ecb);
      break;
    case 16:
      rk_des3_set2key_dec(&ctx3, key);
      rk_crypto_cbc128_decrypt((void *)&ctx3, in, out, length, ivec,
                               rk_des3_crypt_ecb);
      break;
    case 24:
