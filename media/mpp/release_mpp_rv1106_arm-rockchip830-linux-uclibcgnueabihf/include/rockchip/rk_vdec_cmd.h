...
#define MPP_DEC_QUERY_ALL                                                      \
  (MPP_DEC_QUERY_STATUS | MPP_DEC_QUERY_WAIT | MPP_DEC_QUERY_FPS |             \
   MPP_DEC_QUERY_BPS | MPP_DEC_QUERY_DEC_IN_PKT | MPP_DEC_QUERY_DEC_WORK |     \
...
typedef MPP_RET (*MppExtCbFunc)(MppExtCbCtx cb_ctx, MppCtx mpp, RK_S32 cmd,
                                void *arg);
