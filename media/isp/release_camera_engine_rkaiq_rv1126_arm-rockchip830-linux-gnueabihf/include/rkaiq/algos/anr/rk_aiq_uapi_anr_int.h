...
XCamReturn
rk_aiq_bayernr_OverWriteCalibByCurAttr(RkAiqAlgoContext *ctx,
                                       CalibDb_BayerNr_2_t *pCalibdb);

XCamReturn
rk_aiq_ynr_OverWriteCalibByCurAttr(RkAiqAlgoContext *ctx,
                                   CalibDb_YNR_2_t* pYnrCalib);

XCamReturn
rk_aiq_uvnr_OverWriteCalibByCurAttr(RkAiqAlgoContext *ctx,
                                    CalibDb_UVNR_2_t *pCalibdb);

XCamReturn
rk_aiq_mfnr_OverWriteCalibByCurAttr(RkAiqAlgoContext *ctx,
