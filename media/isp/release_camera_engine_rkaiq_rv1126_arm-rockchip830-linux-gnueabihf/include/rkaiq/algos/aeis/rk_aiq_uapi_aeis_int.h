...
XCamReturn rk_aiq_uapi_ais_SetEnable(RkAiqAlgoContext* ctx, bool mode);

XCamReturn rk_aiq_uapi_ais_SetAttrib(RkAiqAlgoContext* ctx, rk_aiq_ais_attrib_t attr,
                                     bool need_sync);
XCamReturn rk_aiq_uapi_ais_GetAttrib(const RkAiqAlgoContext* ctx, rk_aiq_ais_attrib_t* attr);
