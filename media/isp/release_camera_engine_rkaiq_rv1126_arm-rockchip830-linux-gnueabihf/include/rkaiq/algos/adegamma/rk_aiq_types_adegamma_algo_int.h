...
typedef struct Adegamma_api_manual_s {
    bool en;
    float X_axis[DEGAMMA_CRUVE_KNOTS];
    float curve_R[DEGAMMA_CRUVE_KNOTS];
    float curve_G[DEGAMMA_CRUVE_KNOTS];
    float curve_B[DEGAMMA_CRUVE_KNOTS];
