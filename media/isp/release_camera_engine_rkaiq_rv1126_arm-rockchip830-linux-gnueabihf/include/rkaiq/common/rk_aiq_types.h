...
typedef enum rk_aiq_af_zoomcalib_stat_e
{
    RK_AIQ_AF_ZOOM_CALIB_INVALID     = 0,
    RK_AIQ_AF_ZOOM_CALIB_START       = 1,
    RK_AIQ_AF_ZOOM_CALIB_RUN         = 2,
    RK_AIQ_AF_ZOOM_CALIB_CALC_DONE   = 3,
    RK_AIQ_AF_ZOOM_CALIB_COMPLETE    = 4,
    RK_AIQ_AF_ZOOM_CALIB_FAILURE     = 5
} rk_aiq_af_zoomcalib_stat_t;
