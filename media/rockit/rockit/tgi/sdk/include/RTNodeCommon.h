...
#define OPT_AUDIO_REF_CHANNEL_LAYOUT                                           \
  "opt_ref_channel_layout" /*aec process of 3a filter*/
...
#define RT_STRING_LINK_STREAM(s, format, upNodeId, downNodeId)                 \
  s.append(format)                                                             \
      .append("_")                                                             \
      .append(util_to_string(upNodeId))                                        \
      .append("_")                                                             \
      .append(util_to_string(downNodeId))
...
#define RT_NODE_TAG_APPEND(s, id)                                              \
  s.append("\"")                                                               \
      .append(KEY_ROOT_NODE_ID)                                                \
      .append(util_to_string(id))                                              \
      .append("\": {\n")

#define RT_PIPE_TAG_APPEND(s, id)                                              \
  s.append("\"")                                                               \
      .append(KEY_ROOT_PIPE_ID)                                                \
      .append(util_to_string(id))                                              \
      .append("\": {\n")
...
#define RT_TAG_END(s) s.append("},\n")

#define RT_TAG_LAST_END(s) s.append("}\n")
