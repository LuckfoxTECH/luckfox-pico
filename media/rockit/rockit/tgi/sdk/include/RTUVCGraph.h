...
public:
  ...
  RT_RET
  observeUVCOutputStream(std::function<RT_RET(RTMediaBuffer *)> streamCallback);
  RT_RET
  observeNNOutputStream(std::function<RT_RET(RTMediaBuffer *)> streamCallback);
  RT_RET observeMattingOutputStream(
