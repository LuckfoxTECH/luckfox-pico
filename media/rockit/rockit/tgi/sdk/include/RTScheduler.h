 ...
 * new author: modified by <rimon.xu@rock-chips.com> and
 * <martin.cheng@rock-chips.com> date: 2020-03-19 reference:
...
public:
  ...
  void
  scheduleUnthrottledNodes(const std::vector<RTTaskNode *> &nodesToSchedule);
  ...
  RT_RET applicationThreadAwait(const std::function<bool()> &wakeupCondition,
                                INT64 timeoutUs = -1);
  ...
  RT_RET waitUntilGraphInputStreamUnthrottled(RtMutex *secondaryMutex,
                                              INT64 timeoutUs);
