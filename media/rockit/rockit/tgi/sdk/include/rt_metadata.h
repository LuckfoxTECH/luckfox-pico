...
public:
  ...
  virtual RT_BOOL setPointer(UINT64 key, RT_PTR value,
                             RTMetaValueFree freeFunc = RT_NULL);
  ...
  virtual RT_BOOL findStructData(UINT64 key, const void **value,
                                 UINT32 size) const;
  ...
  virtual RT_BOOL setData(UINT64 key, UINT32 type, const void *data,
                          UINT32 size, RTMetaValueFree freeFunc = RT_NULL);

  virtual RT_BOOL findData(UINT64 key, UINT32 *type, const void **data,
                           UINT32 *size) const;
