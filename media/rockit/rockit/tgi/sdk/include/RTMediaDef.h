...
#define RT_SEC_TO_TIME(x)                                                      \
  (static_cast<INT64>(static_cast<double>(x) * RT_TIME_BASE))
#define RT_MSEC_TO_TIME(x)                                                     \
  (static_cast<INT64>(static_cast<double>(x) * RT_TIME_BASE / 1000))
...
typedef enum {
  ...
  RT_AUDIO_ID_TDMAFR,  /**< Any variant of TDMA Fullrate encoded data
                          (TIA/EIA-136-420) */
  RT_AUDIO_ID_TDMAEFR, /**< Any variant of TDMA Enhanced Fullrate encoded data
                          (TIA/EIA-136-410) */
...
/* Need to modify the rkPIXEL_FORMAT_E definition in rk_comm_video.h
 * synchronously */
