...
RK_S32 TEST_COMM_LoadBitmap2Surface(const char *pstFileName,
                                    const OSD_SURFACE_S *pstSurface,
                                    RK_U8 *pu8Virt);
RK_S32 TEST_COMM_CreateSurfaceByBitmap(const char *pstFileName,
                                       OSD_SURFACE_S *pstSurface,
                                       RK_U8 *pu8Virt);
RK_S32 TEST_COMM_GetBmpInfo(const char *filename,
