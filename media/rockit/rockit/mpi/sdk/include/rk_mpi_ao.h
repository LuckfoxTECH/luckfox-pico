...
RK_S32 RK_MPI_AO_SetChnAttr(AUDIO_DEV AoDevId, AO_CHN AoChn, const AO_CHN_ATTR_S *pstAttrs);
RK_S32 RK_MPI_AO_GetChnAttr(AUDIO_DEV AoDevId, AO_CHN AoChn, AO_CHN_ATTR_S *pstAttrs);
