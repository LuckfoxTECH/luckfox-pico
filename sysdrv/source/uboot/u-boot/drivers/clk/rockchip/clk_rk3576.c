...
#else
static struct rockchip_pll_rate_table rk3576_26m_pll_rates[] = {
	/* _mhz, _p, _m, _s, _k */
	RK3588_PLL_RATE(1188000000, 2, 183, 1, 50412),
	RK3588_PLL_RATE(1100000000, 2, 338, 2, 30247),
	RK3588_PLL_RATE(1014000000, 1, 156, 2, 0),
	RK3588_PLL_RATE(1000000000, 2, 308, 2, 45371),
	RK3588_PLL_RATE(858000000, 1, 132, 2, 0),
	RK3588_PLL_RATE(806000000, 1, 124, 2, 0),
	RK3588_PLL_RATE(786432000, 2, 242, 2, 64165),
	RK3588_PLL_RATE(594000000, 2, 183, 2, 50412),
	RK3588_PLL_RATE(297000000, 2, 183, 3, 50412),
	RK3588_PLL_RATE(148500000, 2, 183, 4, 50412),
	{ /* sentinel */ },
};
#endif
...
static int rk3576_clk_bind(struct udevice *dev)
{
	...
	if (ret) {
		...
		sf_priv->sf_reset_offset = offsetof(struct rk3576_cru,
						    softrst_con[0]);
		sf_priv->sf_reset_num = 524454;
...
U_BOOT_DRIVER(rockchip_rk3576_cru) = {
	...
	.priv_auto_alloc_size = sizeof(struct rk3576_clk_priv),
	.ofdata_to_platdata = rk3576_clk_ofdata_to_platdata,
	.ops		= &rk3576_clk_ops,
...
int soc_clk_dump(void)
{
	...
	ret = uclass_get_device_by_driver(UCLASS_CLK,
					  DM_GET_DRIVER(rockchip_rk3576_cru),
					  &cru_dev);
	if (ret) {
