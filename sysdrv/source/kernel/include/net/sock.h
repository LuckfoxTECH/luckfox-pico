...
/* Note: for send buffers, UDP works better if we can build two skbs at
 * default, this value also could be set by setopt in the APPS.
 */
#define SK_WMEM_MAX		(2 * _SK_MEM_OVERHEAD * _SK_MEM_PACKETS)
