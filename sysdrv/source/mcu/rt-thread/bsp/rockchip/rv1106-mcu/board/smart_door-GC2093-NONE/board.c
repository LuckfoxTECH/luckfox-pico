 ...
 * Change Logs:
 * Date           Author       Notes
 * 2022-12-05     Chujin Zhou   first implementation
 */
...
const struct camera_board_desc camera_gc2093 =
{
    .i2c_addr = 0x37,
    .rst_gpio =
    {
    ...
    .pwdn_gpio =
    {
        .gpio_pin = GPIO_PIN_D3,
        .gpio_group = GPIO3,
    },
    .pwren_gpio =
    {
        .gpio_pin = GPIO_PIN_A1,
        .gpio_group = GPIO1,
    },
    .time_valid_delay = 2,
    .gain_valid_delay = 2,
    .mode_id = GC2093_1280X720,
