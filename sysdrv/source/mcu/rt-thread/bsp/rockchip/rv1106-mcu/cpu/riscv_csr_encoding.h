/**
  * Copyright (c) 2012 Rockchip Electronic Co.,Ltd
  *
...
//DECLARE_CSR(ipic_eoi ,IPIC_EOI  )
//DECLARE_CSR(ipic_soi ,IPIC_SOI  )
//DECLARE_CSR(ipic_idx ,IPIC_IDX  )
//DECLARE_CSR(ipic_icsr,IPIC_ICSR )
#endif
#ifdef DECLARE_CAUSE
