...
#define HCI_CONTROL_MISC_COMMAND_GET_TIME                   ( ( HCI_CONTROL_GROUP_MISC << 8 ) | 0x03 )    /* Get RTC Time */
#define HCI_CONTROL_MISC_COMMAND_SET_TIME                   ( ( HCI_CONTROL_GROUP_MISC << 8 ) | 0x04 )    /* Set RTC Time */
