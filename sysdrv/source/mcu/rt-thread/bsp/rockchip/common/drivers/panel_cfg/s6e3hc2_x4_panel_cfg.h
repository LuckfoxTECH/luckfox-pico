/**
  ...
  ******************************************************************************
  * @file    s6e3hc2_x4_panel_cfg.h
  * @version V0.1
  * @brief   display panel config for s6e3hc2 x4
  *
  * Change Logs:
  * Date           Author          Notes
...
#ifndef __S6E3HC2_X4_PANEL_CFG_H__
#define __S6E3HC2_X4_PANEL_CFG_H__

#define RT_HW_LCD_XRES                720      /* LCD PIXEL WIDTH             */
#define RT_HW_LCD_YRES                1560     /* LCD PIXEL HEIGHT            */
#define RT_HW_LCD_PIXEL_CLOCK         72000    /* Pixel clock Khz             */
#define RT_HW_LCD_LANE_MBPS           500      /* DSI per lane Mbps           */
...
#define RT_HW_LCD_VMODE_FLAG          DSI_CLOCK_NON_CONTINUOUS | VIDEO_MODE_FLAG_NHSYNC
...
const static struct rockchip_cmd cmd_on[] =
{
    ...
    {0x07, 0x10, 0x01, {0x00}},
    /* Scaler Enable x4 */
    {0x15, 0x10, 0x02, {0xc3, 0x11}},
    /* PPS Setting */
    {
        0x0a, 0x31, 0x58, {
            0x11, 0x00, 0x00, 0x89, 0x30, 0x80, 0x06, 0x18,
            0x02, 0xd0, 0x00, 0x34, 0x01, 0x68, 0x01, 0x68,
            0x02, 0x00, 0x01, 0xb4, 0x00, 0x20, 0x04, 0x04,
            0x00, 0x05, 0x00, 0x0C, 0x01, 0xe2, 0x02, 0xef,
    ...
    {0x39, 0x00, 0x05, {0x2a, 0x00, 0x00, 0x02, 0xcf}},
    {0x39, 0x00, 0x05, {0x2b, 0x00, 0x00, 0x06, 0x17}},
    ...
    /* Dither IP Setting */
    {0x39, 0x00, 0x03, {0xfc, 0x5a, 0x5a}},
    {0x15, 0x00, 0x02, {0xb0, 0xb6}},
    {0x15, 0x00, 0x02, {0xeb, 0x01}},
    {0x39, 0x00, 0x03, {0xfc, 0xa5, 0xa5}},
    /* 5 Brightness Control */
    /* 5.1 Dimming Setting */
    {0x39, 0x10, 0x03, {0xf0, 0x5a, 0x5a}},
    {0x23, 0x10, 0x02, {0xb0, 0x05}},
    {0x23, 0x10, 0x02, {0xb1, 0x01}},
    {0x23, 0x10, 0x02, {0xb0, 0x02}},
...
#endif /* __S6E3HC2_X4_PANEL_CFG_H__ */
