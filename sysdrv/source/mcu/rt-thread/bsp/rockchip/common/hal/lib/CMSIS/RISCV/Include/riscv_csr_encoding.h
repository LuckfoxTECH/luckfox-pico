...
#define EXC_ECFU 8   /* Environment call from U-mode */
#define EXC_ECFS 9   /* Environment call from S-mode */
#define EXC_ECFM 11  /* Environment call from M-mode */
