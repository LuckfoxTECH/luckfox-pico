...
#ifndef __RK3358_USB_H
#define __RK3358_USB_H
#ifdef __cplusplus
  extern "C" {
#endif
/****************************************************************************************/
...
#define OTG                  ((struct USB_GLOBAL_REG *) OTG_BASE)
#define EHCI                 ((struct EHCI_REG *) EHCI_BASE)
#define OHCI                 ((struct OHCI_REG *) OHCI_BASE)

#define IS_PCD_INSTANCE(instance) ((instance) == OTG)
#define IS_HCD_INSTANCE(instance) ((instance) == OTG)
