...
#define COLOR_SCR        lv_color_hex(0x000000)
#define COLOR_SCR_TEXT   lv_color_hex(0xe7e9ec)

/*BUTTON*/
#define COLOR_BTN           lv_color_hex(0x586273)
#define COLOR_BTN_PR        lv_color_mix(theme.color_primary, COLOR_BTN, LV_OPA_30)
...
#define COLOR_BTN_BORDER_INA    lv_color_hex(0x404040)

/*BACKGROUND*/
#define COLOR_BG            lv_color_hex(0x586273)
#define COLOR_BG_PR         lv_color_hex(0x494f57)
...
#define COLOR_BG_BORDER         lv_color_hex(0x808a97)   /*dfe7ed*/
#define COLOR_BG_BORDER_PR      lv_color_hex(0x5f656e)
#define COLOR_BG_BORDER_CHK     lv_color_hex(0x5f656e)
#define COLOR_BG_BORDER_CHK_PR  lv_color_hex(0x5f656e)
#define COLOR_BG_BORDER_DIS     lv_color_hex(0x5f656e)

#define COLOR_BG_TEXT           lv_color_hex(0xffffff)
#define COLOR_BG_TEXT_PR        lv_color_hex(0xffffff)
#define COLOR_BG_TEXT_CHK       lv_color_hex(0xffffff)
#define COLOR_BG_TEXT_CHK_PR    lv_color_hex(0xffffff)
#define COLOR_BG_TEXT_DIS       lv_color_hex3(0x999)

/*SECONDARY BACKGROUND*/
#define COLOR_BG_SEC            lv_color_hex(0x45494d)
#define COLOR_BG_SEC_BORDER     lv_color_hex(0x404040)
#define COLOR_BG_SEC_TEXT       lv_color_hex(0xa5a8ad)
#define COLOR_BG_SEC_TEXT_DIS   lv_color_hex(0xa5a8ad)
...
#if LV_USE_CLOCK
    lv_style_t clock_main, clock_strong, clock_needle;
#endif
} theme_styles_t;
...
static void basic_init(void)
{
    ...
    lv_style_set_text_color(&styles->btn, LV_STATE_DEFAULT, lv_color_hex(0xffffff));
    lv_style_set_text_color(&styles->btn, LV_STATE_PRESSED, lv_color_hex(0xffffff));
    ...
    lv_style_set_text_color(&styles->btn, LV_STATE_DISABLED, lv_color_hex(0x888888));

    lv_style_set_image_recolor(&styles->btn, LV_STATE_DEFAULT, lv_color_hex(0xffffff));
    ...
    lv_style_set_image_recolor(&styles->btn, LV_STATE_DISABLED, lv_color_hex(0x888888));

    lv_style_set_value_color(&styles->btn, LV_STATE_DEFAULT, lv_color_hex(0xffffff));
    lv_style_set_value_color(&styles->btn, LV_STATE_PRESSED, lv_color_hex(0xffffff));
    ...
    lv_style_set_value_color(&styles->btn, LV_STATE_DISABLED, lv_color_hex(0x888888));
...
static void slider_init(void)
{
    ...
    lv_style_set_value_color(&styles->slider_knob, LV_STATE_DEFAULT, LV_COLOR_WHITE);
...
static void gauge_init(void)
{
    ...
    lv_style_set_line_color(&styles->gauge_needle, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    ...
    lv_style_set_bg_color(&styles->gauge_needle, LV_STATE_DEFAULT, LV_COLOR_WHITE);
...
{
#if LV_USE_CLOCK != 0
    style_init_reset(&styles->clock_main);
    lv_style_set_line_color(&styles->clock_main, LV_STATE_DEFAULT, lv_color_hex3(0x888));
    lv_style_set_scale_grad_color(&styles->clock_main, LV_STATE_DEFAULT, lv_color_hex3(0x888));
    lv_style_set_scale_end_color(&styles->clock_main, LV_STATE_DEFAULT, theme.color_primary);
    lv_style_set_line_width(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(5));
    lv_style_set_scale_end_line_width(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(4));
    lv_style_set_scale_end_border_width(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(8));
    lv_style_set_pad_left(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(20));
    lv_style_set_pad_right(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(20));
    lv_style_set_pad_top(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(20));
    lv_style_set_pad_inner(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(20));
    lv_style_set_scale_width(&styles->clock_main, LV_STATE_DEFAULT, LV_DPX(15));
    lv_style_set_radius(&styles->clock_main, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);

    style_init_reset(&styles->clock_strong);
    lv_style_set_line_color(&styles->clock_strong, LV_STATE_DEFAULT, lv_color_hex3(0x888));
    lv_style_set_scale_grad_color(&styles->clock_strong, LV_STATE_DEFAULT, lv_color_hex3(0x888));
    lv_style_set_scale_end_color(&styles->clock_strong, LV_STATE_DEFAULT, theme.color_primary);
    lv_style_set_line_width(&styles->clock_strong, LV_STATE_DEFAULT, LV_DPX(8));
    lv_style_set_scale_end_line_width(&styles->clock_strong, LV_STATE_DEFAULT, LV_DPX(8));
    lv_style_set_scale_width(&styles->clock_strong, LV_STATE_DEFAULT, LV_DPX(25));

    style_init_reset(&styles->clock_needle);
    lv_style_set_line_color(&styles->clock_needle, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    lv_style_set_line_width(&styles->clock_needle, LV_STATE_DEFAULT, LV_DPX(8));
    lv_style_set_bg_opa(&styles->clock_needle, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&styles->clock_needle, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    lv_style_set_radius(&styles->clock_needle, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
    lv_style_set_size(&styles->clock_needle, LV_STATE_DEFAULT, LV_DPX(30));
    lv_style_set_pad_inner(&styles->clock_needle, LV_STATE_DEFAULT, LV_DPX(80));
#endif
}
...
static void chart_init(void)
{
    ...
    lv_style_set_text_color(&styles->chart_bg, LV_STATE_DEFAULT, lv_color_hex(0xa1adbd));
...
static void calendar_init(void)
{
    ...
    lv_style_set_text_color(&styles->calendar_header, LV_STATE_PRESSED, LV_COLOR_WHITE);

    style_init_reset(&styles->calendar_daynames);
    lv_style_set_text_color(&styles->calendar_daynames, LV_STATE_DEFAULT, lv_color_hex3(0xeee));
    ...
    lv_style_set_text_color(&styles->calendar_date_nums, LV_STATE_CHECKED, LV_COLOR_WHITE);
    ...
    lv_style_set_bg_color(&styles->calendar_date_nums, LV_STATE_DEFAULT, LV_COLOR_WHITE);
...
static void keyboard_init(void)
{
    ...
    lv_style_set_border_color(&styles->kb_bg, LV_STATE_DEFAULT, LV_COLOR_BLACK);
...
static void msgbox_init(void)
{
    ...
    lv_style_set_shadow_color(&styles->mbox_bg, LV_STATE_DEFAULT, lv_color_hex3(0x999));
...
static void page_init(void)
{
    ...
    lv_style_set_bg_color(&styles->sb, LV_STATE_DEFAULT, lv_color_hex(0x777f85));
...
static void textarea_init(void)
{
    ...
    lv_style_set_text_color(&styles->ta_placeholder, LV_STATE_DEFAULT, lv_color_hex(0xa1adbd));
#endif
}
...
static void ddlist_init(void)
{
    ...
    lv_style_set_text_color(&styles->ddlist_sel, LV_STATE_DEFAULT, lv_color_hex3(0xfff));
...
static void tabview_win_shared_init(void)
{
    ...
    lv_style_set_border_color(&styles->tabview_btns_bg, LV_STATE_DEFAULT, lv_color_hex(0x3b3e42));
 ...
 */
lv_theme_t *lv_theme_rtt_init(lv_color_t color_primary, lv_color_t color_secondary, uint32_t flags,
                             ...
                             const lv_font_t *font_title)
{
    ...
    {
#if defined(LV_GC_INCLUDE)
        LV_GC_ROOT(_lv_theme_rtt_styles) = lv_mem_alloc(sizeof(theme_styles_t));
        styles = (theme_styles_t *)LV_GC_ROOT(_lv_theme_rtt_styles);
#else
...
#if LV_USE_CLOCK
    case LV_THEME_CLOCK:
        list = lv_obj_get_style_list(obj, LV_CLOCK_PART_MAIN);
        _lv_style_list_add_style(list, &styles->bg);
        _lv_style_list_add_style(list, &styles->clock_main);

        list = lv_obj_get_style_list(obj, LV_CLOCK_PART_MAJOR);
        _lv_style_list_add_style(list, &styles->clock_strong);

        list = lv_obj_get_style_list(obj, LV_CLOCK_PART_NEEDLE);
        _lv_style_list_add_style(list, &styles->clock_needle);
        break;
#endif
    default:
        break;
