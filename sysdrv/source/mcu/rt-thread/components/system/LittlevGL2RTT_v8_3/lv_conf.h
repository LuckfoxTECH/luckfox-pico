...
#define LV_HOR_RES_MAX          (RT_HW_LCD_XRES)
#define LV_VER_RES_MAX          (RT_HW_LCD_YRES)

#ifdef RT_HW_LCD_XRES
#define LV_HOR_RES RT_HW_LCD_XRES
#endif

#ifdef RT_HW_LCD_YRES
...
/*Use RK GPU RK2108 platforms*/
#define LV_USE_GPU_RK 0
#define LV_USE_FULL_SCREEN 1
...
#define LV_ATTRIBUTE_FAST_MEM __attribute__ ((section((".sram.text"))))
//#define LV_ATTRIBUTE_FAST_MEM __attribute__ ((section((".dtcm"))))
...
#ifdef RT_LV_FONT_MONTSERRAT_8
#define LV_FONT_MONTSERRAT_8    1
#endif
#ifdef RT_LV_FONT_MONTSERRAT_10
