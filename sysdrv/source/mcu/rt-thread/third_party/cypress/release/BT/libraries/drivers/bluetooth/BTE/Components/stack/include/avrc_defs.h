...
**
**  Copyright (c) 2006-2015, Broadcom Corp., All Rights Reserved.
...
typedef UINT8 tAVRC_PLAYER_SETTING;
#define AVRC_MAX_NUM_PLAYER_SETTING             4
...
typedef UINT32 tAVRC_MEDIA_ATTR_ID;
#define AVRC_MAX_NUM_MEDIA_ATTR_ID               AVRC_MEDIA_ATTR_ID_COVER_ART
...
/* Media Content Navigation - Scope */
