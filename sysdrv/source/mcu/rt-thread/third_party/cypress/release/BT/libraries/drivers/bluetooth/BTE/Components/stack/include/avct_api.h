...
/*******************************************************************************
**
** Function         AVCT_SetBufferPool
**
** Description      If buffer_size > 0 and AVCT does not have a private pool yet,
**                  this function allocates a private GKI buffer pool for AVCT module.
**                  If buffer_size = 0 and AVCT has a private pool,
**                  this function deallocates the private GKI buffer pool for AVCT module.
**
** Returns          AVCT_SUCCESS if successful, otherwise error.
**
******************************************************************************/
AVCT_API extern UINT16 AVCT_SetBufferPool(UINT16 buffer_size,
        UINT16 buffer_count);
