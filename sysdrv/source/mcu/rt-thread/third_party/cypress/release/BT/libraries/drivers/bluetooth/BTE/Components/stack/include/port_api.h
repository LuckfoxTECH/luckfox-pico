...
#define PORT_INVALID_MTU            (PORT_ERR_BASE + 8)
...
**                                 0, to use the default maximum frame size calculated based on the biggest buffer pool size.
**                                 If mtu is bigger than the biggest buffer pool size minus the overhead for L2CAP and RFCOMM,
**                                 this functions returns WICED_BT_RFCOMM_INVALID_MTU.
