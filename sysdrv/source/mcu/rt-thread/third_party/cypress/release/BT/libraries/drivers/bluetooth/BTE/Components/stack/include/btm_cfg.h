 ...
 *
 * IMPORTANT: Must match wiced_bt_cfg.h
 */
#pragma once
...
typedef struct
{
    ...
    uint8_t                             max_number_of_buffer_pools;     /**< Maximum number of buffer pools in p_btm_cfg_buf_pools and by GKI_create_pool */
...
extern wiced_bt_cfg_settings_t *p_btm_cfg_settings;
...
/*******************************************************************************
**
** Function         BTM_CfgStack
**
** Description      Over-ride default stack / gki configuration
**
** Returns          NOthing
**
*******************************************************************************/
BTM_API extern void BTM_CfgStack(const wiced_bt_cfg_settings_t *p_bt_new_cfg_settings,
                                 const wiced_bt_cfg_buf_pool_t bt_new_cfg_buf_pools[WICED_BT_CFG_NUM_BUF_POOLS]);
