...
#define AVCT_CH_OPEN    2       /* Channel opened */
...
typedef struct
{
    ...
    tAVCT_LCB       *lcb;                   /* link control blocks */
    tAVCT_BCB       *bcb;                   /* browse control blocks */
    tAVCT_CCB       *ccb;                   /* connection control blocks */
    UINT8           num_conn;               /* Number of avct CCBs */
    ...
    wiced_pool_t    *p_buf_pool;            /* private buffer pool */
...
extern UINT8 avct_bcb_last_ccb(tAVCT_BCB *p_bcb, tAVCT_CCB *p_ccb_last);
...
extern tL2CAP_APPL_INFO avct_l2c_appl;
#if (AVCT_BROWSE_INCLUDED == TRUE)
extern tL2CAP_APPL_INFO avct_l2c_br_appl;
#endif
