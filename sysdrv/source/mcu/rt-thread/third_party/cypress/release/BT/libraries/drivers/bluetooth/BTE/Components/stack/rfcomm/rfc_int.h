...
#define RFC_MX_STATE_WAIT_CONNECTED 1
...
#define RFC_STATE_OPENED                3
#define RFC_STATE_DISC_WAIT_UA          4
...
#define RFC_MX_EVENT_CONNECTED          9
...
#define RFC_EVENT_TX_COMPLETE           16

#define RFC_T1_TIMEOUT                  10   /* seconds to wait for reply with Poll bit */
#define RFC_PORT_T1_TIMEOUT             60   /* seconds to wait for reply with Poll bit other than MX */
#define RFC_T2_TIMEOUT                  10   /* timeout to wait for Mx UIH */
...
typedef struct
{
    ...
    tRFC_MCB **p_rfc_lcid_mcb;              /* MCB based on the L2CAP's lcid */
#else
...
extern void      rfc_add_tx_complete_pending(UINT16 lcid, UINT16 num_rfc_data_bufs);
extern void      rfc_allocate_tx_complete_pending_table(void);
extern void      rfc_free_tx_complete_pending_table(void);
extern void      rfc_handle_tx_complete(UINT16 lcid, UINT16 num_buffers);
extern void      rfc_port_flush_pending_tx_complete(tPORT *p_port);
extern void      rfc_port_notify_tx_complete(tPORT *p_port, UINT16 tx_complete_idx);
