...
#define BT_LOGMSG_ENABLE(x)
#endif

#if (BT_USE_TRACES == TRUE)
#include <rtthread.h>
#define BT_TRACE_0(l,t,m)                           rt_kprintf(m "\n")
#define BT_TRACE_1(l,t,m,p1)                        rt_kprintf(m "\n",(UINTPTR)(p1))
#define BT_TRACE_2(l,t,m,p1,p2)                     rt_kprintf(m "\n",(UINTPTR)(p1), (UINTPTR)(p2))
#define BT_TRACE_3(l,t,m,p1,p2,p3)                  rt_kprintf(m "\n",(UINTPTR)(p1), (UINTPTR)(p2),(UINTPTR)(p3))
#define BT_TRACE_4(l,t,m,p1,p2,p3,p4)               rt_kprintf(m "\n",(UINTPTR)(p1), (UINTPTR)(p2),(UINTPTR)(p3),(UINTPTR)(p4))
#define BT_TRACE_5(l,t,m,p1,p2,p3,p4,p5)            rt_kprintf(m "\n",(UINTPTR)(p1), (UINTPTR)(p2),(UINTPTR)(p3),(UINTPTR)(p4), (UINTPTR)(p5))
#define BT_TRACE_6(l,t,m,p1,p2,p3,p4,p5,p6)         rt_kprintf(m "\n",(UINTPTR)(p1), (UINTPTR)(p2),(UINTPTR)(p3),(UINTPTR)(p4), (UINTPTR)(p5),(UINTPTR)(p6))

#define BT_ERROR_TRACE_0(l,m)                     rt_kprintf(m "\n")
#define BT_ERROR_TRACE_1(l,m,p1)                  rt_kprintf(m "\n",(UINTPTR)(p1))
#define BT_ERROR_TRACE_2(l,m,p1,p2)               rt_kprintf(m "\n",(UINTPTR)(p1),(UINTPTR)(p2))
#define BT_ERROR_TRACE_3(l,m,p1,p2,p3)            rt_kprintf(m "\n",(UINTPTR)(p1),(UINTPTR)(p2),(UINTPTR)(p3))
...
//#ifndef RT_USING_BOARD_RK2108B_EVB
#ifndef RT_CYPRESS_BT
...
#define APPL_TRACE_ERROR0(m)                    do{rt_kprintf("\n"); rt_kprintf(m);} while(0)
#define APPL_TRACE_ERROR1(m,p1)                 do{rt_kprintf("\n"); rt_kprintf(m, p1);} while(0)
#define APPL_TRACE_ERROR2(m,p1,p2)              do{rt_kprintf("\n"); rt_kprintf(m, p1, p2);} while(0)
#define APPL_TRACE_ERROR3(m,p1,p2,p3)           do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3);} while(0)
#define APPL_TRACE_ERROR4(m,p1,p2,p3,p4)        do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4);} while(0)
#define APPL_TRACE_ERROR5(m,p1,p2,p3,p4,p5)     do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5);} while(0)
#define APPL_TRACE_ERROR6(m,p1,p2,p3,p4,p5,p6)  do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5, p6);} while(0)

#define APPL_TRACE_WARNING0(m)                  do{rt_kprintf("\n"); rt_kprintf(m);} while(0)
#define APPL_TRACE_WARNING1(m,p1)               do{rt_kprintf("\n"); rt_kprintf(m, p1);} while(0)
#define APPL_TRACE_WARNING2(m,p1,p2)            do{rt_kprintf("\n"); rt_kprintf(m, p1, p2);} while(0)
#define APPL_TRACE_WARNING3(m,p1,p2,p3)         do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3);} while(0)
#define APPL_TRACE_WARNING4(m,p1,p2,p3,p4)      do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4);} while(0)
#define APPL_TRACE_WARNING5(m,p1,p2,p3,p4,p5)   do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5);} while(0)
#define APPL_TRACE_WARNING6(m,p1,p2,p3,p4,p5,p6) do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5, p6);} while(0)

#define APPL_TRACE_API0(m)                      do{rt_kprintf("\n"); rt_kprintf(m);} while(0)
#define APPL_TRACE_API1(m,p1)                   do{rt_kprintf("\n"); rt_kprintf(m, p1);} while(0)
#define APPL_TRACE_API2(m,p1,p2)                do{rt_kprintf("\n"); rt_kprintf(m, p1, p2);} while(0)
#define APPL_TRACE_API3(m,p1,p2,p3)             do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3);} while(0)
#define APPL_TRACE_API4(m,p1,p2,p3,p4)          do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4);} while(0)
#define APPL_TRACE_API5(m,p1,p2,p3,p4,p5)       do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5);} while(0)
#define APPL_TRACE_API6(m,p1,p2,p3,p4,p5,p6)    do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5, p6);} while(0)

#define APPL_TRACE_EVENT0(m)                    do{rt_kprintf("\n"); rt_kprintf(m);} while(0)
#define APPL_TRACE_EVENT1(m,p1)                 do{rt_kprintf("\n"); rt_kprintf(m, p1);} while(0)
#define APPL_TRACE_EVENT2(m,p1,p2)              do{rt_kprintf("\n"); rt_kprintf(m, p1, p2);} while(0)
#define APPL_TRACE_EVENT3(m,p1,p2,p3)           do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3);} while(0)
#define APPL_TRACE_EVENT4(m,p1,p2,p3,p4)        do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4);} while(0)
#define APPL_TRACE_EVENT5(m,p1,p2,p3,p4,p5)     do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5);} while(0)
#define APPL_TRACE_EVENT6(m,p1,p2,p3,p4,p5,p6)  do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5, p6);} while(0)

#define APPL_TRACE_DEBUG0(m)                    do{rt_kprintf("\n"); rt_kprintf(m);} while(0)
#define APPL_TRACE_DEBUG1(m,p1)                 do{rt_kprintf("\n"); rt_kprintf(m, p1);} while(0)
#define APPL_TRACE_DEBUG2(m,p1,p2)              do{rt_kprintf("\n"); rt_kprintf(m, p1, p2);} while(0)
#define APPL_TRACE_DEBUG3(m,p1,p2,p3)           do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3);} while(0)
#define APPL_TRACE_DEBUG4(m,p1,p2,p3,p4)        do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4);} while(0)
#define APPL_TRACE_DEBUG5(m,p1,p2,p3,p4,p5)     do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5);} while(0)
#define APPL_TRACE_DEBUG6(m,p1,p2,p3,p4,p5,p6)  do{rt_kprintf("\n"); rt_kprintf(m, p1, p2, p3, p4, p5, p6);} while(0)
