...
/* GKI Trace Macros */
#define GKI_TRACE_0     rt_kprintf
#define GKI_TRACE_1     rt_kprintf
#define GKI_TRACE_2     rt_kprintf
#define GKI_TRACE_3     rt_kprintf
#define GKI_TRACE_4     rt_kprintf
#define GKI_TRACE_5     rt_kprintf
#define GKI_TRACE_6     rt_kprintf
#define GKI_TRACE_7     rt_kprintf

#define GKI_TRACE_ERROR_0     rt_kprintf
#define GKI_TRACE_ERROR_1     rt_kprintf
#define GKI_TRACE_ERROR_2     rt_kprintf
#define GKI_TRACE_ERROR_3     rt_kprintf
#define GKI_TRACE_ERROR_4     rt_kprintf
#define GKI_TRACE_ERROR_5     rt_kprintf
#define GKI_TRACE_ERROR_6     rt_kprintf
#define GKI_TRACE_ERROR_7     rt_kprintf
