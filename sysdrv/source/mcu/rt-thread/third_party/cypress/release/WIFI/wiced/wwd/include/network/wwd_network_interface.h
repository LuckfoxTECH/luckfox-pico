...
typedef void (*ethernet_filter_tx_packet_t)(wiced_buffer_t buffer, void *userdata);
 ...
 * @param userdata           : Opaque data pointer to pass back to application in callback.
 */
extern void host_ethernet_set_tx_packet_filter(ethernet_filter_tx_packet_t tx_packet_callback, void *userdata);
