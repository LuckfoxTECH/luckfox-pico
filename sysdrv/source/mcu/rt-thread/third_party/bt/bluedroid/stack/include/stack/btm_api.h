...
/* relate to RK_IO_CAP_xxx in rk_gap_ble_api.h */
...
*/
/* relate to RK_LE_KEY_xxx in rk_gap_ble_api.h */
#if (SMP_INCLUDED == TRUE)
...
/* relate to RK_LE_AUTH_xxx in rk_gap_ble_api.h */
#if (SMP_INCLUDED == TRUE)
...
typedef struct
{
    ...
    tBTM_LE_KEY_TYPE    rrk_keys;      /* keys to be distributed, bit mask */
} tBTM_LE_IO_REQ;
