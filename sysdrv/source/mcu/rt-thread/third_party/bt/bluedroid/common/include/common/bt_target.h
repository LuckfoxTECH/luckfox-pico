...
#endif /* #if defined(CONFIG_CLASSIC_BT_ENABLED) */
...
**
******************************************************************************/
#if defined(CONFIG_GATTS_ENABLE)
#define GATTS_INCLUDED              TRUE
#else
#define GATTS_INCLUDED              FALSE
#endif /* CONFIG_GATTS_ENABLE */

#if defined(CONFIG_GATTC_ENABLE)
#define GATTC_INCLUDED              TRUE
#else
#define GATTC_INCLUDED              FALSE
#endif  /* CONFIG_GATTC_ENABLE */

#if (defined(CONFIG_GATTC_ENABLE) && defined(CONFIG_GATTC_CACHE_NVS_FLASH))
#define GATTC_CACHE_NVS              TRUE
#else
#define GATTC_CACHE_NVS              FALSE
#endif  /* CONFIG_GATTC_CACHE_NVS_FLASH */

#if defined(CONFIG_SMP_ENABLE)
...
#else
#define BLE_ADV_REPORT_FLOW_CONTROL  TRUE
...
#ifdef BT_ACL_CONNECTIONS
#define MAX_ACL_CONNECTIONS  BT_ACL_CONNECTIONS
#define GATT_MAX_PHY_CHANNEL BT_ACL_CONNECTIONS
#endif  /* CONFIG_BT_ACL_CONNECTIONS */

#ifdef CONFIG_BLE_ESTABLISH_LINK_CONNECTION_TIMEOUT
...
#else
#define BTM_BLE_ACTIVE_SCAN_REPORT_ADV_SCAN_RSP_INDIVIDUALLY    TRUE
#endif
