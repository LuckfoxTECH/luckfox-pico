...
extern void aicwf_sdio_host_init(struct sdio_host_env_tag *env, void *cb,
				 void *shared_env_ptr, void *pthis);

extern void aicwf_sdio_host_txdesc_push(struct sdio_host_env_tag *env,
					const int queue_idx,
					const uint64_t host_id);

extern void aicwf_sdio_host_tx_cfm_handler(struct sdio_host_env_tag *env,
					   u32 *data);
